              ...
              <div class="usage-export-popover">
                <div class="usage-export-list">
                  <button
                    ...
                    @click=${()=>se(`hemlock-usage-sessions-${Se}.csv`,le(x),`text/csv`)}
                    ?disabled=${x.length===0}
                  >
                  ...
                  <button
                    class="usage-export-item"
                    @click=${()=>se(`hemlock-usage-daily-${Se}.csv`,ue(G),`text/csv`)}
                    ?disabled=${G.length===0}
                  >
                  ...
                  <button
                    class="usage-export-item"
                    @click=${()=>se(`hemlock-usage-${Se}.json`,JSON.stringify({totals:I,sessions:x,daily:G,aggregates:V},null,2),`application/json`)}
...
//# sourceMappingURL=usage-K-4BNS2i.js.map