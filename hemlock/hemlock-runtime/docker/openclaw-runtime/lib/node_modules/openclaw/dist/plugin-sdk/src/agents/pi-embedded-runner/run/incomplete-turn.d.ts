...
type IncompleteTurnAttempt = Pick<EmbeddedRunAttemptResult, "clientToolCall" | "yieldDetected" | "didSendDeterministicApprovalPrompt" | "lastToolError" | "lastAssistant" | "replayMetadata" | "promptErrorSource" | "timedOutDuringCompaction">;
