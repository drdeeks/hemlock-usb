...
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-DvNGLnmF.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BfihYtV2.js";
import { _ as sendPayloadMediaSequenceAndFinalize, b as sendTextMediaPayload, f as resolvePayloadMediaUrls } from "./reply-payload-C-MyOxXD.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-bXrpGuZ5.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate } from "./common-BTJs9jR5.js";
import { a as normalizeInteractiveReply, o as resolveInteractiveTextFallback } from "./payload-D2IJKyz2.js";
import { o as isSingleUseReplyToMode } from "./reply-threading-ZY94ykJe.js";
import { t as resolveOutboundSendDep } from "./send-deps-BtbJzzlt.js";
import { t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-DQ2y7w8c.js";
import "./text-runtime-3VPC1sGh.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-h0Gn9zFj.js";
import { r as createChatChannelPlugin } from "./core-DaNQJg_E.js";
import "./channel-core-DnL1WWaZ.js";
import { t as normalizeOutboundThreadId } from "./routing-Ewkev_pm.js";
import "./error-runtime-Da0X1TOQ.js";
import { x as createOpenProviderConfiguredRouteWarningCollector } from "./channel-policy-no84IHKf.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-BcseZZYc.js";
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BP8-nbbZ.js";
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-DzWK0uJx.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-YncCu3-v.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-rPdRacuP.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-Csb7hAJZ.js";
import { t as extractToolSend } from "./tool-send-Ds6SE8VW.js";
import { n as resolveApprovalApprovers, t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-Duj02slu.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-Cam6K90N.js";
import "./approval-delivery-runtime-xTf3cZVh.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-CKOa4Onj.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-IjPSb9mx.js";
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-Ci0KfX4D.js";
import "./approval-native-runtime-plT845fZ.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-D1798JLA.js";
import "./reply-reference-BIC68hoE.js";
import "./outbound-runtime--HEvGZCa.js";
import "./plugin-runtime-C42rLU84.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-CxMdpY_U.js";
import { n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-Cb6KUw5K.js";
import "./channel-actions-F0Sc8q9h.js";
import { i as createAttachedChannelResultAdapter, t as attachChannelToResult } from "./channel-send-result-eblsyUhk.js";
import "./param-readers-CCM_Owby.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, n as listSlackAccountIds, o as resolveSlackReplyToMode, t as listEnabledSlackAccounts } from "./accounts-K85qz17O.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-B7n5eyXZ.js";
import { a as resolveSlackExecApprovalTarget, i as normalizeSlackApproverId, n as isSlackExecApprovalAuthorizedSender, o as shouldHandleSlackExecApprovalRequest, r as isSlackExecApprovalClientEnabled, s as shouldSuppressLocalSlackExecApprovalPrompt, t as getSlackExecApprovalApprovers } from "./exec-approvals-C6nqSOEv.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-Bz00lW1U.js";
import { n as parseSlackBlocksInput } from "./blocks-input-67q0EmAq.js";
import { i as buildSlackInteractiveBlocks, t as resolveSlackReplyBlocks } from "./reply-blocks-D8vqPXPE.js";
import "./channel-api-BUcYgSMz.js";
import { r as createSlackWebClient } from "./client-B9pKkzjh.js";
import { r as normalizeAllowListLower } from "./allow-list-CpDnwrM6.js";
import { a as resolveSlackGroupToolPolicy, i as resolveSlackGroupRequireMention, n as getSlackRuntime, t as getOptionalSlackRuntime } from "./runtime-BwzdOvpF.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-B4i89cWv.js";
import { t as collectSlackSecurityAuditFindings } from "./security-audit-BB7WcJOc.js";
import { a as isSlackPluginAccountConfigured, i as createSlackPluginBase, n as slackSetupAdapter, o as slackConfigAdapter, r as SLACK_CHANNEL, t as slackSetupWizard } from "./setup-surface-CkysrhQ4.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DeDgxeR4.js")).slackApprovalNativeRuntime
	})
});
...
async function loadSlackActionRuntime$1() {
	slackActionRuntimePromise$1 ??= import("./action-runtime.runtime-CwPeOuJh.js");
...
async function loadSlackSendRuntime$1() {
	slackSendRuntimePromise$1 ??= import("./send.runtime-COLYXkOF.js");
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-Ddsge6Q_.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Dl5N1eNT.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CBxDCk-a.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime-CwPeOuJh.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-COLYXkOF.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-B1XsoyhV.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-DvB-H7sO.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-Bi_teiOc.js");
