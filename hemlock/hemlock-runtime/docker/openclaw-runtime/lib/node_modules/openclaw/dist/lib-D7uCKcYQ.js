...
import { t as require_src } from "./src-BQBzShaU.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-3J97RlgQ.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-fXOmqUcf.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-zT5dc89s.js";
import { l as toRatio, n as decodeString } from "./Util-b8AD8su_.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CYvmi5U9.js";
import { t as APEv2Parser } from "./APEv2Parser-MxGzkCAY.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CYnchk4T.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BKwVLXq3.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DhSwWR3f.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-WZXtebbV.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-Qp3oZ1zc.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-Dkjtp9aE.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DWYLxqqD.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BEwcMA0b.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CACP--s1.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser--h25kKas.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DZ53HRyM.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CryGfx69.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CYkGxeIx.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DHDNgyFh.js")).WaveParser;
	}
};
//#endregion
