...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DeXXoUde.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-ZUx9SnUD.js";
...
import { t as getLoadedChannelPluginById } from "./registry-loaded-Dl9bbNwL.js";
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CAnQx2oU.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, x as parseAgentSessionKey } from "./session-key-L2XsSJT_.js";
import "./defaults-BckzHLk4.js";
import { i as applyMergePatch } from "./schema-validator-hIxo3xY6.js";
import { r as logVerbose } from "./globals-DQvpEApL.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-_11V2h5W.js";
import { a as resolveAgentDir, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, n as listAgentEntries, p as resolveAgentSkillsFilter, y as resolveSessionAgentId } from "./agent-scope-C7LiYj5W.js";
import "./config-M6t0-B38.js";
import { b as resetRegisteredAgentHarnessSessions } from "./loader-b5gxFmeZ.js";
...
import { m as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-B5JkXHFO.js";
import { c as normalizeThinkLevel, n as formatXHighModelHint, u as normalizeVerboseLevel } from "./thinking.shared-BZ7s87RR.js";
import { f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-DP92S76A.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CrHqfnMp.js";
import { d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-BHZEWLw5.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-DBAnocn4.js";
import { S as resolveGroupSessionKey, a as resolveSessionStoreEntry, c as updateSessionStore, m as resolveMaintenanceConfigFromInput, v as deriveSessionMetaPatch } from "./store-Cw5RrVCw.js";
import { t as normalizeChatType } from "./chat-type-C4hxgoqs.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-D3efLc-S.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-CpbhSLaW.js";
import { c as resolveThreadFlag, i as resolveChannelResetConfig, n as evaluateSessionFreshness, o as resolveSessionResetPolicy, s as resolveSessionResetType } from "./reset-CSt9R-yj.js";
import { n as resolveSessionKey } from "./session-key-CLSm5qo5.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-OqD5syUc.js";
import { t as loadSessionStore } from "./store-load-DsLWM8wp.js";
import { t as resolveAndPersistSessionFile } from "./session-file-C9xMnbq2.js";
import { t as parseSessionThreadInfo } from "./thread-info-BFSP_iUR.js";
import "./delivery-context-BGHNA3rL.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-JOCs7lw4.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CIoRklU5.js";
...
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-DzEKj41v.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BuMB4mti.js";
import { i as supportsXHighThinking } from "./thinking-Clu_erps.js";
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-acACZGZo.js";
...
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-CIPnjy6o.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-YqA7ta9g.js";
import { t as buildOutboundSessionContext } from "./session-context-ggI5NhQm.js";
import { t as resolveQueueSettings } from "./settings-runtime-BlEQlb9I.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-DtGfqu5w.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CO8Rj16_.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-CxRNYZoP.js";
import { t as hasControlCommand } from "./command-detection-DNYq9uM-.js";
import "./commands-registry-DxeiLwP6.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-lQKz4Ile.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-bgd2O_xW.js";
import { t as finalizeInboundContext } from "./inbound-context-BM3S6N92.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-l34d7rAH.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BimfLHao.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-nX-Ulzk2.js";
import { t as resolveChannelModelOverride } from "./model-overrides-CLFYHxky.js";
...
import { n as resolveBlockStreamingChunking } from "./block-streaming-4s4ohtgp.js";
import { t as resolveCommandAuthorization } from "./command-auth-K6v9wqMC.js";
import { t as buildCommandContext } from "./commands-context-Dn274BaE.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-_EralPyH.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-D7sdc5km.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-B8Wnp8eq.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DhSY2rfM.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DIRYxf_5.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-CE7RCK4a.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-D-3kYXoB.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-DWg-uFVJ.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-DVv_P1jp.js";
import { t as buildBareSessionResetPrompt } from "./session-reset-prompt-Cva3ztXM.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-po_iBhF8.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-Di6sblwn.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-BLPtF2Iz.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-BpIUzQ78.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-caNVY6-7.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-qW5JEIyi.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-BFjp1U82.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-BzrzKb4l.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-BqBlp0rv.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-CEbv6iUa.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-BMwd6DXQ.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-BMwd6DXQ.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-DXo1ERTT.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-Ce5fWnXn.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-Br9-oR91.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-Br9-oR91.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-ePKOB3LA.js");
...
function resolveInboundFormattingHints(ctx) {
	...
	return (getLoadedChannelPluginById(normalizeAnyChannelId(channelValue) ?? channelValue)?.agentPrompt)?.inboundFormattingHints?.({ accountId: normalizeOptionalString(ctx.AccountId) ?? void 0 });
}
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-CXudtSvj.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-CUJd1OG7.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-CE6Gm8xr.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-3u-4wn9F.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-NHnop8Np.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-0ENrf2Aq.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BuWQVWCc.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-C1CwHCeS.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-CpE9h8qd.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-Domdfmxf.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-BaZVpfHU.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-CkJCd9Iu.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-hpRek8iT.js");
