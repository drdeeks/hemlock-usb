import{f as e,o as t,r as n,u as r}from"./i18n-DotGtgSo.js";import{u as i}from"./format-B2C6aZJe.js";import{t as a}from"./string-coerce-BcFtIWA_.js";import{C as o,S as s,_ as c,a as l,c as u,d,g as f,h as p,i as m,l as h,m as g,o as _,r as v,s as y,t as b,v as x,w as S,x as C,y as w}from"./agents-utils-DfRztsjd.js";import{t as T}from"./icons-CYdCcAbH.js";import{a as E,n as D,r as O,t as k}from"./presenter-BPwsKcBD.js";import{r as A}from"./channel-config-extras-Ds0C-MxE.js";import{i as j,n as M,r as N,t as P}from"./skills-shared-DGYI1x_6.js";function F(t){let{agent:i,configForm:a,agentFilesList:o,configLoading:s,configSaving:c,configDirty:l,onConfigReload:_,onConfigSave:v,onModelChange:y,onModelFallbacksChange:b,onSelectPanel:x}=t,S=d(a,i.id),C=i.model,w=(o&&o.agentId===i.id?o.workspace:null)||S.entry?.workspace||S.defaults?.workspace||i.workspace||`default`,T=S.entry?.model?p(S.entry?.model):S.defaults?.model?p(S.defaults?.model):p(C),E=p(S.defaults?.model??C),D=f(S.entry?.model),O=f(S.defaults?.model)||(E===`-`?null:u(E))||(a?null:f(C)),k=D??O??null,A=g(S.entry?.model)??g(S.defaults?.model)??(a?null:g(C))??[],j=Array.isArray(S.entry?.skills)?S.entry?.skills:null,M=j?.length??null,N=!!(t.defaultId&&i.id===t.defaultId),P=!a||s||c,F=e=>{let t=A.filter((t,n)=>n!==e);b(i.id,t)};return e`
    <section class="card">
          ...
          <div class="field">
            ...
            >
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let n=h(t.value);n.length>0&&(b(i.id,[...A,...n]),t.value=``)}}}
                @blur=${e=>{let t=e.target,n=h(t.value);n.length>0&&(b(i.id,[...A,...n]),t.value=``)}}
              />
            </div>
          </div>
        </div>
...
${e}
  ...
  `}function $(t){let i=t.jobs.filter(e=>e.agentId===t.agentId);return e`
    <section class="grid grid-cols-2">
      ...
      <section class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${E(t.status?.nextWakeAtMs??null)}</div>
          </div>
        </div>
        ${t.error?e`<div class="callout danger" style="margin-top: 12px;">${t.error}</div>`:r}
      </section>
            ...
            <div class="list" style="margin-top: 16px;">
              ${i.map(n=>e`
                  <div class="list-item">
                    ...
                    <div class="list-meta">
                      <div class="mono">${O(n)}</div>
                      <div class="muted">${k(n)}</div>
                      <button
                        class="btn btn--sm"
  ...
  `}function me(t){let i=t.agentFilesList?.agentId===t.agentId?t.agentFilesList:null,a=i?.files??[],c=t.agentFileActive??null,l=c?a.find(e=>e.name===c)??null:null,u=c?t.agentFileContents[c]??``:``,d=c?t.agentFileDrafts[c]??u:``,f=c?d!==u:!1;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
                    ...
                    >
                      <div class="md-preview-dialog__panel">
                        ...
                        <div class="md-preview-dialog__body">
                          ${S(se(s.parse(d,{gfm:!0,breaks:!0}),{sanitize:e=>o.sanitize(e)}))}
                        </div>
                      </div>
                    </dialog>
  ...
  `}function he(t,n){let i=n.source??t.source,a=n.pluginId??t.pluginId,o=[];return i===`plugin`&&a?o.push(`plugin:${a}`):i===`core`&&o.push(`core`),n.optional&&o.push(`optional`),o.length===0?r:e`
    <div style="display: flex; gap: 6px; flex-wrap: wrap; margin-top: 6px;">
      ${o.map(t=>e`<span class="agent-pill">${t}</span>`)}
    </div>
  `}function ge(e){return e.source===`plugin`?e.pluginId?n(`agentTools.connectedSource`,{id:e.pluginId}):n(`agentTools.connected`):e.source===`channel`?e.channelId?n(`agentTools.channelSource`,{id:e.channelId}):n(`agentTools.channel`):n(`agentTools.builtIn`)}function _e(t){let i=d(t.configForm,t.agentId),a=i.entry?.tools??{},o=i.globalTools??{},s=a.profile??o.profile??`full`,u=x(t.toolsCatalogResult),f=w(t.toolsCatalogResult),p=a.profile?`agent override`:o.profile?`global default`:`default`,m=Array.isArray(a.allow)&&a.allow.length>0,h=Array.isArray(o.allow)&&o.allow.length>0,g=!!t.configForm&&!t.configLoading&&!t.configSaving&&!m&&!(t.toolsCatalogLoading&&!t.toolsCatalogResult&&!t.toolsCatalogError),v=m?[]:Array.isArray(a.alsoAllow)?a.alsoAllow:[],y=m?[]:Array.isArray(a.deny)?a.deny:[],b=m?{allow:a.allow??[],deny:a.deny??[]}:c(s)??void 0,S=f.flatMap(e=>e.tools.map(e=>e.id)),T=e=>{let t=l(e,b),n=_(e,v),r=_(e,y);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},E=S.filter(e=>T(e).allowed).length,D=(e,n)=>{let r=new Set(v.map(e=>C(e)).filter(e=>e.length>0)),i=new Set(y.map(e=>C(e)).filter(e=>e.length>0)),a=T(e).baseAllowed,o=C(e);n?(i.delete(o),a||r.add(o)):(r.delete(o),i.add(o)),t.onOverridesChange(t.agentId,[...r],[...i])},O=e=>{let n=new Set(v.map(e=>C(e)).filter(e=>e.length>0)),r=new Set(y.map(e=>C(e)).filter(e=>e.length>0));for(let t of S){let i=T(t).baseAllowed,a=C(t);e?(r.delete(a),i||n.add(a)):(n.delete(a),r.add(a))}t.onOverridesChange(t.agentId,[...n],[...r])};return e`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        <div style="min-width: 0;">
          ...
          <div class="card-sub">
            ...
            <span class="mono">${E}/${S.length}</span> enabled.
          </div>
        </div>
      ...
      <div class="agent-tools-grid" style="margin-top: 20px;">
        ${f.map(t=>e`
            <div class="agent-tools-section">
              ...
              <div class="agent-tools-list">
                ${t.tools.map(n=>{let{allowed:r}=T(n.id);return e`
                    <div class="agent-tool-row">
                      <div>
  ...
  `}function ve(t){let i=!!t.configForm&&!t.configLoading&&!t.configSaving,o=d(t.configForm,t.agentId),s=Array.isArray(o.entry?.skills)?o.entry?.skills:void 0,c=new Set((s??[]).map(e=>e.trim()).filter(Boolean)),l=s!==void 0,u=!!(t.report&&t.activeAgentId===t.agentId),f=u?t.report?.skills??[]:[],p=a(t.filter),m=p?f.filter(e=>a([e.name,e.description,e.source].join(` `)).includes(p)):f,h=j(m),g=l?f.filter(e=>c.has(e.name)).length:f.length,_=f.length;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        <div style="min-width: 0;">
  ...
  `}function ye(t,n){return e`
    <details class="agent-skills-group" ?open=${!(t.id===`workspace`||t.id===`built-in`)}>
      ...
      <div class="list skills-grid">
        ${t.skills.map(e=>be(e,{agentId:n.agentId,allowSet:n.allowSet,usingAllowlist:n.usingAllowlist,editable:n.editable,onToggle:n.onToggle}))}
      </div>
    </details>
  `}function be(t,n){let i=n.usingAllowlist?n.allowSet.has(t.name):!0,a=P(t),o=M(t);return e`
    ...
    <div class="agents-layout">
      ...
      <section class="agents-main">
        ${s?e`
              ...
              ${t.activePanel===`channels`?pe({context:v(s,t.config.form,t.agentFiles.list,a,t.agentIdentityById[s.id]??null),configForm:t.config.form,snapshot:t.channels.snapshot,loading:t.channels.loading,error:t.channels.error,lastSuccess:t.channels.lastSuccess,onRefresh:t.onChannelsRefresh,onSelectPanel:t.onSelectPanel}):r}
              ${t.activePanel===`cron`?$({context:v(s,t.config.form,t.agentFiles.list,a,t.agentIdentityById[s.id]??null),agentId:s.id,jobs:t.cron.jobs,status:t.cron.status,loading:t.cron.loading,error:t.cron.error,onRefresh:t.onCronRefresh,onRunNow:t.onCronRunNow,onSelectPanel:t.onSelectPanel}):r}
            `:e`
              <div class="card">
  ...
  `}export{xe as renderAgents};
//# sourceMappingURL=agents-DhCg7EXC.js.map