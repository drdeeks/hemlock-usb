...
import { a as getLogger, i as getChildLogger, o as getResolvedLoggerSettings } from "./logger-CnaMaZPi.js";
import { d as isNotFoundPathError, o as sameFileIdentity, r as openBoundaryFile } from "./boundary-file-read-C2FDLxpR.js";
import { b as truncateUtf16Safe, m as resolveUserPath, s as ensureDir, v as sleep, x as isPlainObject } from "./utils-D5DtWkEu.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-DtKxDfkA.js";
import { n as defaultRuntime } from "./runtime-Df11Xt6R.js";
import { t as sanitizeForLog } from "./ansi-lD0AkxvX.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-D2gFnOcq.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-jndHmrmK.js";
...
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-Da6QT2bI.js";
import { n as VERSION, s as resolveRuntimeServiceVersion } from "./version-BI-p49mK.js";
import { _ as resolveStateDir, i as isNixMode, r as STATE_DIR } from "./paths-HZHKO_Jn.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-BhFwYAnZ.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CAnQx2oU.js";
import { _ as isAcpSessionKey, b as isSubagentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, v as isCronRunSessionKey, x as parseAgentSessionKey } from "./session-key-L2XsSJT_.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-DvNGLnmF.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-BckzHLk4.js";
import { i as applyMergePatch } from "./schema-validator-hIxo3xY6.js";
import { n as resolveAgentModelPrimaryValue } from "./model-input-Deq97_rK.js";
import { n as matchesSkillFilter } from "./agent-filter-CEM-NSLp.js";
import { a as logWarn, n as logError, t as logDebug } from "./logger-BYB3iw-K.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-xi_1oMVJ.js";
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_SOUL_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_TOOLS_FILENAME, o as DEFAULT_MEMORY_ALT_FILENAME, p as isWorkspaceSetupCompleted, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_MEMORY_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as DEFAULT_USER_FILENAME } from "./workspace-_11V2h5W.js";
import { a as resolveAgentDir, g as resolveEffectiveModelFallbacks, h as resolveDefaultAgentId, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, n as listAgentEntries, p as resolveAgentSkillsFilter, r as listAgentIds, y as resolveSessionAgentId } from "./agent-scope-C7LiYj5W.js";
import { a as normalizePluginsConfig } from "./config-state-DmPson1J.js";
import { r as parseByteSize } from "./zod-schema-Cug88AX2.js";
import { t as parseDurationMs } from "./parse-duration-DRwx2zpl.js";
import "./config-M6t0-B38.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-BPEiUrBJ.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-BQpH8jex.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-rMc8VJBA.js";
import { r as loadOpenClawPlugins, v as disposeRegisteredAgentHarnesses } from "./loader-b5gxFmeZ.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-DB_0wnJl.js";
import { s as getPluginCommandSpecs } from "./command-registration-Bmks-tEe.js";
import { o as runGlobalGatewayStopSafely, t as getGlobalHookRunner } from "./hook-runner-global-BfihYtV2.js";
import { f as registerInternalHook, h as unregisterInternalHook, i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent, p as setInternalHooksEnabled } from "./internal-hooks-CEPnFgdQ.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-Da5rkMU1.js";
import { b as createEmptyPluginRegistry, f as releasePinnedPluginChannelRegistry, l as pinActivePluginChannelRegistry, p as releasePinnedPluginHttpRouteRegistry, r as getActivePluginRegistry, u as pinActivePluginHttpRouteRegistry, v as resolveActivePluginHttpRouteRegistry, y as setActivePluginRegistry } from "./runtime-B5JkXHFO.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-WsL2shdJ.js";
import "./logging-B8ph7hAz.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-DPmdr3gC.js";
import { a as normalizeElevatedLevel, c as normalizeThinkLevel, l as normalizeUsageDisplay, n as formatXHighModelHint, o as normalizeFastMode, s as normalizeReasoningLevel, u as normalizeVerboseLevel } from "./thinking.shared-BZ7s87RR.js";
import { D as parseModelRef, E as normalizeModelRef, S as isCliProvider, a as getModelRefStatus, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, l as resolveAllowedModelRef, p as resolveHooksGmailModel, s as normalizeModelSelection, t as buildAllowedModelSet, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection } from "./model-selection-DP92S76A.js";
import { t as formatCliCommand } from "./command-format-CwCsVPsh.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-8NaL9h-u.js";
import { t as safeEqualSecret } from "./secret-equal-CY79Jp85.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-DntgCa38.js";
import { _ as resolveRequestClientIp, a as isLoopbackHost, g as resolveHostName, h as resolveGatewayListenHosts, i as isLoopbackAddress, l as isTrustedProxyAddress, m as resolveGatewayBindHost, n as isContainerEnvironment, o as isPrivateOrLoopbackAddress, p as resolveClientIp, r as isLocalishHost, s as isPrivateOrLoopbackHost, t as defaultGatewayBindMode, u as isValidIPv4 } from "./net-BWcjOlSf.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-B5jhzVVE.js";
import { a as resolveEffectiveSharedGatewayAuth, i as isLocalDirectRequest, n as authorizeHttpGatewayConnect, o as resolveGatewayAuth, r as authorizeWsControlUiGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-BbsY8q8P.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CrHqfnMp.js";
import { r as pickBestEffortPrimaryLanIPv4 } from "./control-ui-links-B-V8dnYt.js";
import { i as resolveAssistantAvatarUrl, r as normalizeControlUiBasePath } from "./control-ui-shared-DF4Q-l-t.js";
import { n as normalizeDeviceAuthScopes } from "./device-auth-PzcHBEky.js";
import { a as getPreauthHandshakeTimeoutMsFromEnv, i as resolveDeviceAuthConnectErrorDetailCode, n as ConnectErrorDetailCodes, o as buildDeviceAuthPayload, r as resolveAuthConnectErrorDetailCode, s as buildDeviceAuthPayloadV3 } from "./client-mAkhLNco.js";
import { i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity, o as verifyDeviceSignature, r as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-CY2OKQsD.js";
import { t as rawDataToString } from "./ws-BRmHzU5W.js";
import { a as isGatewayMessageChannel, c as isOperatorUiClient, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS, i as isGatewayCliClient, l as isWebchatClient, m as GATEWAY_CLIENT_CAPS, n as isBrowserOperatorUiClient, r as isDeliverableMessageChannel, v as hasGatewayClientCap } from "./message-channel-BHZEWLw5.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-CyF97UKo.js";
import { $ as validateNodeInvokeParams, $t as validateWizardNextParams, A as validateCronRunParams, At as validateSessionsMessagesUnsubscribeParams, Bt as validateSkillsSearchParams, C as validateConfigSchemaLookupResult, Ct as validateSessionsCompactionGetParams, D as validateCronAddParams, Dt as validateSessionsDeleteParams, E as validateConnectParams, Et as validateSessionsCreateParams, F as validateDevicePairListParams, Ft as validateSessionsSendParams, G as validateExecApprovalsNodeGetParams, Gt as validateTalkSpeakParams, H as validateExecApprovalRequestParams, Ht as validateSkillsUpdateParams, I as validateDevicePairRejectParams, It as validateSessionsUsageParams, J as validateLogsTailParams, Jt as validateUpdateRunParams, K as validateExecApprovalsNodeSetParams, Kt as validateToolsCatalogParams, L as validateDevicePairRemoveParams, Lt as validateSkillsBinsParams, M as validateCronStatusParams, Mt as validateSessionsPreviewParams, N as validateCronUpdateParams, Nt as validateSessionsResetParams, O as validateCronListParams, Ot as validateSessionsListParams, P as validateDevicePairApproveParams, Pt as validateSessionsResolveParams, Q as validateNodeEventParams, Qt as validateWizardCancelParams, R as validateDeviceTokenRevokeParams, Rt as validateSkillsDetailParams, S as validateConfigSchemaLookupParams, St as validateSessionsCompactionBranchParams, T as validateConfigSetParams, Tt as validateSessionsCompactionRestoreParams, U as validateExecApprovalResolveParams, Ut as validateTalkConfigParams, V as validateExecApprovalGetParams, Vt as validateSkillsStatusParams, W as validateExecApprovalsGetParams, Wt as validateTalkModeParams, X as validateModelsListParams, Xt as validateWebLoginStartParams, Y as validateMessageActionParams, Yt as validateWakeParams, Z as validateNodeDescribeParams, Zt as validateWebLoginWaitParams, _t as validateSecretsResolveParams, a as validateAgentsCreateParams, at as validateNodePairRequestParams, b as validateConfigGetParams, bt as validateSessionsAbortParams, c as validateAgentsFilesListParams, ct as validateNodePendingDrainParams, d as validateAgentsUpdateParams, dt as validatePluginApprovalRequestParams, en as validateWizardStartParams, et as validateNodeInvokeResultParams, f as validateChannelsLogoutParams, ft as validatePluginApprovalResolveParams, ht as validateRequestFrame, i as validateAgentWaitParams, in as parseSessionLabel, it as validateNodePairRejectParams, j as validateCronRunsParams, jt as validateSessionsPatchParams, k as validateCronRemoveParams, kt as validateSessionsMessagesSubscribeParams, l as validateAgentsFilesSetParams, lt as validateNodePendingEnqueueParams, mt as validatePushTestParams, n as validateAgentIdentityParams, nn as ErrorCodes, nt as validateNodePairApproveParams, o as validateAgentsDeleteParams, ot as validateNodePairVerifyParams, p as validateChannelsStatusParams, pt as validatePollParams, q as validateExecApprovalsSetParams, qt as validateToolsEffectiveParams, r as validateAgentParams, rn as errorShape, rt as validateNodePairListParams, s as validateAgentsFilesGetParams, st as validateNodePendingAckParams, t as formatValidationErrors, tn as validateWizardStatusParams, tt as validateNodeListParams, u as validateAgentsListParams, ut as validateNodeRenameParams, v as validateCommandsListParams, vt as validateSecretsResolveResult, w as validateConfigSchemaParams, wt as validateSessionsCompactionListParams, x as validateConfigPatchParams, xt as validateSessionsCompactParams, y as validateConfigApplyParams, yt as validateSendParams, z as validateDeviceTokenRotateParams, zt as validateSkillsInstallParams } from "./protocol-CnJ5gHtr.js";
import { a as normalizeInputProvenance } from "./input-provenance-DBAnocn4.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-AwuoIB_P.js";
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, i as isNodeRoleMethod, l as READ_SCOPE, n as authorizeOperatorScopesForMethod, o as ADMIN_SCOPE$1, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES, u as TALK_SECRETS_SCOPE } from "./method-scopes-BfEsKHVS.js";
import { n as isRestartEnabled } from "./commands.flags-D4SUGIkX.js";
import { n as formatConfigIssueLines } from "./issue-format-CAv_M0Bu.js";
import { t as ensureOpenClawModelsJson } from "./models-config-WTeIlzbI.js";
import { r as loadModelCatalog } from "./model-catalog-CiEGd-YZ.js";
import { n as resolveAgentIdentity } from "./identity-LLtDOuch.js";
import { c as updateSessionStore, l as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-Cw5RrVCw.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-D3efLc-S.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-BWz-crFz.js";
import { c as setSessionRuntimeModel, n as mergeSessionEntry } from "./types-CpbhSLaW.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-rU6v-RfX.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-CqKpq7YD.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-OqD5syUc.js";
import { t as loadSessionStore } from "./store-load-DsLWM8wp.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-CUasLUvU.js";
import { t as parseSessionThreadInfo } from "./thread-info-BFSP_iUR.js";
import { i as resolveAgentSessionDirs } from "./targets-X-Vp8dFb.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-Co9E7aKq.js";
import { t as lookupContextTokens } from "./context-DZxBSnX2.js";
import { n as getLatestSubagentRunByChildSessionKey, t as countActiveDescendantRuns } from "./subagent-registry-read-B0Y6T4Dm.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-p2lxz2Ig.js";
...
import { c as hasNonzeroUsage, s as deriveSessionTotalTokens } from "./chat-envelope-DGarBiZe.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-C8REwkJD.js";
import { r as stripInlineDirectiveTagsForDisplay } from "./directive-tags-BqJjXrwT.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts, t as archiveFileOnDisk } from "./session-transcript-files.fs-BG4yy1yb.js";
import { $ as listSessionCompactionCheckpoints, Q as getSessionCompactionCheckpoint } from "./compact-g-BGaE4t.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-Do9ynpdK.js";
import { _ as startDiagnosticHeartbeat, v as stopDiagnosticHeartbeat } from "./diagnostic-V8lZDXn5.js";
import { f as CommandLane, i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-JOCs7lw4.js";
import { m as resolveEmbeddedAgentRuntime } from "./attempt.tool-run-context-98fz_X4e.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-CIoRklU5.js";
import { s as stripHeartbeatToken } from "./heartbeat-B5UCaFTR.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-gj7vcoJz.js";
import { t as getMachineDisplayName } from "./machine-name-CfOcLd4e.js";
import { t as detectMime } from "./mime-Ci7oOV2D.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-g32FpVk_.js";
import { a as compactEmbeddedPiSession, i as resolvePreferredSessionKeyForSessionIdMatches, o as selectAgentHarness, t as runEmbeddedPiAgent } from "./pi-embedded-runner-DXh-tqVs.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-D6czjo8S.js";
import { d as PROFILE_OPTIONS, m as resolveCoreToolProfiles, p as listCoreToolSections } from "./tool-policy-DzEKj41v.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-Clu_erps.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-CtIcMWPU.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-BjoqUC62.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-DKe4b6qW.js";
import { t as SsrFBlockedError } from "./ssrf-tCiyDHOt.js";
import { a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-CjBTircm.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-C-MyOxXD.js";
import { c as getAgentRunContext, d as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-BrSNDEDb.js";
import { c as runWithModelFallback, d as normalizeHttpWebhookUrl, f as normalizeCronJobCreate, g as isInvalidCronSessionTargetIdError, h as assertSafeCronSessionTargetId, l as LiveSessionModelSwitchError, m as normalizeCronJobPatch, p as normalizeCronJobInput } from "./openclaw-tools-C-4xhzGY.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-BhpFcpTV.js";
import { T as resolveExecApprovalRequestAllowedDecisions, _ as normalizeExecTarget, d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions, y as readExecApprovalsSnapshot } from "./exec-approvals-BIBEOnML.js";
import { c as normalizeTargetForProvider } from "./reply-payloads-dedupe-OtM2z7YX.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-8QEK3mgv.js";
import { d as readLocalFileSafely, g as writeFileWithinRoot, t as SafeOpenError } from "./fs-safe-x0_RgCMh.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-Daz6Of-o.js";
import { o as resolveSystemRunApprovalRequestContext, s as resolveSystemRunApprovalRuntimeContext } from "./pi-tools-D36Y1JfN.js";
import { i as setHeartbeatsEnabled, n as requestHeartbeatNow } from "./heartbeat-wake-BfJ_tPlY.js";
import { a as isSystemEventContextChanged, r as enqueueSystemEvent } from "./system-events-BwxCjOwe.js";
import { D as resolveNestedAgentLane, _ as cleanupBrowserSessionsForLifecycleEnd, h as onSessionLifecycleEvent, j as shouldDowngradeDeliveryToSessionOnly, n as countActiveDescendantRuns$1, o as initSubagentRegistry, p as scheduleSubagentOrphanRecovery, s as listDescendantRunsForRequester, y as movePathToTrash } from "./subagent-registry-DK_dIom2.js";
import { n as normalizePollInput } from "./polls-3XsyVR4E.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-UW53ser_.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DLqCNDhx.js";
import { l as failDelivery, o as ackDelivery, s as enqueueDelivery } from "./delivery-queue-DlULVbWl.js";
import { i as resolveReplyToMode } from "./reply-threading-ZY94ykJe.js";
import { t as buildOutboundSessionContext } from "./session-context-ggI5NhQm.js";
import { h as mapAllowFromEntries } from "./channel-config-helpers-DQ2y7w8c.js";
import { a as resolveOutboundTargetWithPlugin, i as resolveSessionDeliveryTarget, r as resolveOutboundTarget } from "./targets-BF9FcXlT.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BfZJCi6V.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-CEUDZK7h.js";
import { i as normalizeRequiredName, n as normalizeOptionalAgentId, r as normalizePayloadToSystemText } from "./normalize-EPqiG4LC.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BwuU9VQo.js";
import { a as summarizeRestartSentinel, n as formatDoctorNonInteractiveHint, r as formatRestartSentinelMessage, s as writeRestartSentinel, t as consumeRestartSentinel } from "./restart-sentinel-BXSSW-hm.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, o as scheduleGatewaySigusr1Restart, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-Bt7rOgat.js";
import { r as cleanOldMedia } from "./store-CA7OW_2w.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-BglnERA6.js";
import { i as isKnownSecretTargetId } from "./target-registry-BpX2EZ01.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-CQYnY_2w.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-D7dOQebh.js";
import { i as resolveOutboundSessionRoute, o as maybeResolveIdLikeTarget, r as ensureOutboundSessionEntry, s as resetDirectoryCache, u as dispatchChannelMessageAction } from "./message-action-runner-CtbsPp-L.js";
import { t as buildChannelAccountBindings } from "./bindings-jJUBAsUi.js";
import { t as extractToolPayload } from "./tool-payload-BX5uK_8i.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, r as completeTaskRunByRunId } from "./task-executor-iCllQvE8.js";
import { r as clearSessionQueues } from "./queue-AttL4x6M.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-CU8RMdxt.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DC2W1N-r.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Be5OnPsr.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BLYWZDXD.js";
import { a as mapHookExternalContentSource, i as isExternalHookSession, n as detectSuspiciousPatterns, o as resolveHookExternalContentSource, t as buildSafeExternalPrompt } from "./external-content-Dvi5xKdO.js";
import { _ as verifyNodeToken, a as recordRemoteNodeInfo, b as registerSkillsChangeListener, c as removeRemoteNodeInfo, d as getPairedNode, f as listNodePairing, g as updatePairedNodeMetadata, h as requestNodePairing, i as primeRemoteSkillsCache, l as setSkillsRemoteRegistry, m as renamePairedNode, o as refreshRemoteBinsForConnectedNodes, p as rejectNodePairing, r as getRemoteSkillEligibility, s as refreshRemoteNodeBins, t as canExecRequestNode, u as approveNodePairing, y as getSkillsSnapshotVersion } from "./exec-defaults-biqpT_Yr.js";
import { r as buildWorkspaceSkillSnapshot, s as loadWorkspaceSkillEntries } from "./skills-B5qdBn1G.js";
import { n as hasBinary } from "./config-eval-lWuxd31L.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-H9tt_URA.js";
import { c as roleScopesAllow, o as resolveMissingRequestedScope } from "./pairing-token-BEXVdXTd.js";
import { n as resolveCronStyleNow } from "./current-time-DZdq-swh.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-DHcuNami.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DCXo-WWP.js";
import { t as resolveModel } from "./model-CPrqtDbi.js";
import "./pi-embedded-HwLIt9IG.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-DCGD0-5j.js";
import { n as getAcpSessionManager } from "./manager-Cb2395Jz.js";
import { t as primeConfiguredBindingRegistry } from "./binding-registry-BHFJTk6-.js";
import { r as listPluginCommands } from "./commands-DfFyjwfl.js";
import { n as createPluginRuntime, r as setGatewaySubagentRuntime } from "./runtime-WveJxcdu.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-CBtBHm-R.js";
import "./commands-registry-DxeiLwP6.js";
import { o as getTotalPendingReplies } from "./dispatch-Cdc7z0Lu.js";
import { n as resolveSendPolicy, t as normalizeSendPolicy } from "./send-policy-Lu57G5Jt.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-bgd2O_xW.js";
import { t as getChannelActivity } from "./channel-activity-CJh4neFM.js";
import { o as readChannelAllowFromStoreSync } from "./pairing-store-EKDwEjkm.js";
import { t as WizardCancelledError } from "./prompts-Cr3vrs6n.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-BLMY9vC-.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CKOa4Onj.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DsyQdqeW.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-Cbz4KCvq.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-CneiMrx3.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-CKC4ZPHG.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-Bkv-y2h-.js";
import { t as normalizeGroupActivation } from "./group-activation-DE-s16nb.js";
import { t as resolveFastModeState } from "./fast-mode-UNbdVKGo.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DhSY2rfM.js";
import { t as buildBareSessionResetPrompt } from "./session-reset-prompt-Cva3ztXM.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-B5n9-bz_.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-DFIk9JMg.js";
import { n as resolveAgentOutboundIdentity } from "./identity-BUsSaT8c.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-BFyrfgWM.js";
import { n as parseVerboseOverride, t as applyVerboseOverride } from "./level-overrides-BVgHlav1.js";
import { c as setActiveMcpLoopbackRuntime, i as getCliSessionId, s as clearActiveMcpLoopbackRuntime, t as runCliAgent } from "./cli-runner-CC0iw0JL.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, r as agentCommandFromIngress } from "./agent-command-BUw17dbz.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-Dexn6NH9.js";
import "./refresh-BlMkV3zf.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CPXkc0SE.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed, r as normalizeDeclaredNodeCommands } from "./node-command-policy-C2zbAtAA.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-B569uTBd.js";
import { a as respondUnavailableOnNodeInvokeError, i as respondInvalidParams, n as mergeGatewayAuthConfig, o as respondUnavailableOnThrow, r as mergeGatewayTailscaleConfig, s as safeParseJson, t as ensureGatewayStartupAuth } from "./startup-auth-DfywKJPt.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CIoe-VR6.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-pIEQ_qR0.js";
import { _ as verifyDeviceToken, a as getPairedDevice, c as listDevicePairing, d as removePairedDevice, f as requestDevicePairing, g as updatePairedDeviceMetadata, h as summarizeDeviceTokens, i as formatDevicePairingForbiddenMessage, l as listEffectivePairedDeviceRoles, m as rotateDeviceToken, n as approveDevicePairing, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as ensureDeviceToken, s as listApprovedPairedDeviceRoles, t as approveBootstrapDevicePairing, u as rejectDevicePairing } from "./device-pairing-BUJLX8kD.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-CrOeWkZU.js";
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-BqljXKK2.js";
import "./agent-CpKb5qlW.js";
import { n as shouldIncludeHook } from "./config-CTCjIgNU.js";
import "./cli-runner.runtime-CdX7boay.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dgs0_T-_.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-DYkduzyZ.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-qsV_H0jX.js";
import { t as loadProviderUsageSummary } from "./provider-usage-iwBqBWyY.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-t8tftw_j.js";
import { a as loadSessionUsageTimeSeries, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-Smgwxty0.js";
import { a as performGatewaySessionReset } from "./session-reset-service-BbTFUiQT.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CR3m87sH.js";
import { m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-C6zyl19b.js";
import { a as removeGroundedShortTermCandidates, i as removeBackfillDiaryEntries, n as previewGroundedRemMarkdown, o as writeBackfillDiaryEntries } from "./memory-core-bundled-runtime-BcwkfmWM.js";
import { t as buildChannelUiCatalog } from "./catalog-CkHFsCOK.js";
import { a as redactConfigSnapshot, i as redactConfigObject, o as restoreRedactedValues, r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-HP9KKAMz.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-DzZPWGVb.js";
import { n as getHealthSnapshot } from "./health-BKzChwSG.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BwNen5BL.js";
import { t as GatewayLockError } from "./gateway-lock-CxcT5g7q.js";
import { t as loadWorkspaceHookEntries } from "./workspace-fmam_Clc.js";
import { t as readConfiguredLogTail } from "./log-tail-DeXLO60D.js";
import { i as resolveGatewayStartupPluginIds, r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-D4rzcwpO.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BRBu3ndT.js";
import { t as installSkill } from "./skills-install-Sm3tE2MG.js";
import { a as runChannelPluginStartupMaintenance, i as normalizeCronJobIdentityFields, n as computeNextRunAtMs, o as runGatewayUpdate, r as computePreviousRunAtMs, t as coerceFiniteScheduleNumber } from "./schedule-lV0Lqt3k.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-BfnLbuuK.js";
import { t as runSetupWizard } from "./setup-DG478iTi.js";
import "./status-BOs6JtRt.js";
import { t as getStatusSummary } from "./status.summary-DDz0OT0S.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-B0f6-0Ul.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BpiiHfDF.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-DSZhSL8h.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeLogArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-BE3GOyT3.js";
import { t as buildChannelAccountSnapshot } from "./status-CKRUQnv_.js";
import { n as isLikelyInterimCronMessage, t as expectsSubagentFollowup } from "./subagent-followup-hints-BR69d_kd.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CKjcBmUu.js";
import { A as isSessionKeyAllowedByPrefix, B as resolveHookTargetAgentId, D as getHookChannelError, E as getHookAgentPolicyError, F as readJsonBody, H as applyHookMappings, I as resolveHookChannel, L as resolveHookDeliver, M as normalizeHookDispatchSessionKey, N as normalizeHookHeaders, O as getHookSessionKeyPrefixError, P as normalizeWakePayload, R as resolveHookIdempotencyKey, T as extractHookToken, U as resolveFunctionModuleExport, V as resolveHooksConfig, _ as sendGatewayAuthFailure, a as getHeader, h as loadGatewayModelCatalog, i as getBearerToken, j as normalizeAgentPayload, k as isHookAgentAllowed, l as resolveHttpBrowserOriginPolicy, m as __resetModelCatalogCacheForTest, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, x as setDefaultSecurityHeaders, z as resolveHookSessionKey } from "./http-utils-ayBjqC34.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DJHSYAxJ.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Bz-t8g5q.js";
import { a as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-U2x6TbnN.js";
import { _ as injectTimestamp, a as DEDUPE_TTL_MS, c as MAX_PAYLOAD_BYTES, d as isSuppressedControlReplyLeadFragment, f as isSuppressedControlReplyText, g as waitForTerminalGatewayDedupe, h as setGatewayDedupeEntry, i as DEDUPE_MAX, l as MAX_PREAUTH_PAYLOAD_BYTES, m as readTerminalSnapshotFromGatewayDedupe, n as chatHandlers, o as HEALTH_REFRESH_INTERVAL_MS, p as abortChatRunById, s as MAX_BUFFERED_BYTES, u as TICK_INTERVAL_MS, v as timestampOptsFromConfig } from "./chat-Dt_LXfi0.js";
import { t as resolveGatewayScopedTools } from "./tool-resolution-COFKvURl.js";
import { t as truncateCloseReason } from "./close-reason-SByRsSjf.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-tcNPQcLo.js");
...
function createGatewayCloseHandler(params) {
	return async (opts) => {
		try {
			...
			if (!await Promise.race([closePromise.then(() => true), new Promise((resolve) => setTimeout(() => resolve(false), WEBSOCKET_CLOSE_GRACE_MS))])) {
				...
				await Promise.race([closePromise, new Promise((resolve) => setTimeout(() => {
...
async function loadTargetsRuntime() {
	targetsRuntimePromise ??= import("./targets.runtime-DRmQqBG1.js");
...
async function loadChannelSelectionRuntime() {
	channelSelectionRuntimePromise ??= import("./channel-selection.runtime-DuwdxAYU.js");
...
async function loadGatewayCallRuntime() {
	gatewayCallRuntimePromise ??= import("./call.runtime-D-a6v7TX.js");
	return await gatewayCallRuntimePromise;
}
async function loadDeliveryOutboundRuntime() {
	deliveryOutboundRuntimePromise ??= import("./delivery-outbound.runtime-B9gFpam_.js");
	return await deliveryOutboundRuntimePromise;
}
async function loadSubagentFollowupRuntime() {
	subagentFollowupRuntimePromise ??= import("./subagent-followup.runtime-BHrR9OmX.js");
...
async function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-ePKOB3LA.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-BMs3Bxao.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-1UR-qKiZ.js");
}
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-Bl1CpUlS.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-SzF_wXlH.js");
	...
	send: async ({ params, respond, context, client }) => {
		...
		const work = (async () => {
			try {
				...
				const mirrorMediaUrls = mirrorPayloads.flatMap((payload) => resolveSendableOutboundReplyParts(payload).mediaUrls);
...
const sessionsHandlers = {
	...
	"sessions.reset": async ({ params, respond, context }) => {
		...
		const { performGatewaySessionReset } = await import("./sessions.runtime-CHTjqwZO.js");
		const result = await performGatewaySessionReset({
			key,
			reason,
	...
	"sessions.delete": async ({ params, respond, client, isWebchatConnect, context }) => {
		...
		const { archiveSessionTranscriptsForSessionDetailed, cleanupSessionBeforeMutation, emitGatewaySessionEndPluginHook, emitSessionUnboundLifecycleEvent } = await import("./sessions.runtime-CHTjqwZO.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-D0zuQ9f1.js");
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DwRBfs4W.js");
		const { deliverOutboundPayloads } = await import("./deliver-xr4ze2lA.js");
...
function startGatewayRuntimeServices(params) {
	const heartbeatRunner = params.minimalTestGateway ? createNoopHeartbeatRunner() : startHeartbeatRunner({ cfg: params.cfgAtStart });
...
function getBundledChannelsModule() {
	bundledChannelsModulePromise ??= import("./bundled-1GvKPcJ7.js");
	return bundledChannelsModulePromise;
}
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-BWDnp9Uf.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BKlfXfAt.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-DUe1Prb1.js");
	return embeddingsHttpModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-C5iq8ljj.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-CzszgQpR.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-rGpkPsDI.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-10ehUgAD.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-e7Pqo5Oz.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-QwoDUWcH.js");
	...
	return {
		...
		close: () => new Promise((resolve, reject) => {
			httpServer.close((error) => {
				if (!error) clearActiveMcpLoopbackRuntime(token);
				if (error) {
					reject(error);
					return;
				}
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	try {
		...
		const unavailableGatewayMethods = new Set(minimalTestGateway ? [] : ["chat.history"]);
