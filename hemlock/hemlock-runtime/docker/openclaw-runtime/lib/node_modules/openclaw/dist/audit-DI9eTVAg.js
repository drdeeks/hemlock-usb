...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-HZHKO_Jn.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-B4TpMTxm.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-L2XsSJT_.js";
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-D5XXp4K4.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-CbmEoJpI.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-rMc8VJBA.js";
import { i as hasNonEmptyString } from "./channel-target-B8ece2RY.js";
import { t as hasPotentialConfiguredChannels } from "./config-presence-Bi1jPo3m.js";
...
import { H as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-BIBEOnML.js";
...
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BIoaE4eL.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-DwXDrQkT.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-DO6rEiE6.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-fQos0xHb.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-BjmWkZcE.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-Dm6grTff.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-DShVRNwN.js"),
		import("./probe-auth-D87SW7YN.js"),
		import("./probe-B-x5DsiR.js")
