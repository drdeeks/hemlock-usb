...
import { s as isPrivateOrLoopbackHost } from "./net-BWcjOlSf.js";
import "./text-runtime-3VPC1sGh.js";
import { O as promptAccountId, Q as splitSetupEntries, t as addWildcardAllowFrom, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BD6nhg53.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-C7GnI70h.js";
import { i as hasLegacyFlatAllowPrivateNetworkAlias, o as isPrivateNetworkOptInEnabled, s as migrateLegacyFlatAllowPrivateNetworkAlias } from "./ssrf-policy-B9ZyjgPE.js";
import "./ssrf-runtime-DgTiz1oy.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-CeyRsGw5.js";
import { s as resolveMatrixAccountConfig, t as resolveMatrixConfigFieldPath } from "./config-paths-DjVNc5so.js";
import { l as resolveValidatedMatrixHomeserverUrl, s as resolveMatrixEnvAuthReadiness, u as validateMatrixHomeserverUrl } from "./config-DzrMqyOz.js";
import "./env-auth-C0BMdVSV.js";
...
import { n as moveSingleMatrixAccountConfigToNamedAccount } from "./setup-core-DJqVQ0rn.js";
import { t as updateMatrixAccountConfig } from "./config-update-b3588rr8.js";
import "./client-D9R1RdPx.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "./resolve-targets-v70iD4Md.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-DkmwS7rF.js";
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-Cz9Rztpo.js");
