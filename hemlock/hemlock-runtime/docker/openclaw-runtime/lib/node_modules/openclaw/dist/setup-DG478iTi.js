...
import { h as writeConfigFile, l as readConfigFileSnapshot } from "./io-B-YPX79V.js";
import { u as resolveGatewayPort } from "./paths-HZHKO_Jn.js";
...
import { n as buildPluginCompatibilityNotices, s as formatPluginCompatibilityNotice } from "./status-nt90vpYy.js";
...
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-0Z6X5YCr.js");
...
async function runSetupWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-1CalGTkX.js");
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-Ccxccg7x.js");
		const { logConfigUpdated } = await import("./logging-PQL_S1L_.js");
	...
	const { applyLocalSetupWorkspaceConfig } = await import("./onboard-config-B6uEeSLY.js");
	let nextConfig = applyLocalSetupWorkspaceConfig(baseConfig, workspaceDir);
	const { ensureAuthProfileStore } = await import("./agents/auth-profiles.runtime.js");
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-ZX23Qqwe.js");
	const { promptCustomApiConfig } = await import("./onboard-custom-BZfR1u2R.js");
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-Cm6LtmYF.js");
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-AQmuP8lX.js");
	...
	const { configureGatewayForSetup } = await import("./setup.gateway-config-CGiI3_Y0.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-DO6rEiE6.js");
		const { setupChannels } = await import("./onboard-channels-BuzqDx4T.js");
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-BQu5HwzV.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-BfLyWTZe.js");
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	if (flow !== "quickstart") {
		const { setupPluginConfig } = await import("./setup.plugin-config-BpGYt2GN.js");
	...
	const { setupInternalHooks } = await import("./onboard-hooks-CzawTK_C.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeSetupWizard } = await import("./setup.finalize-DAOC_W7Z.js");
