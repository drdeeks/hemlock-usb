import { a as normalizePluginsConfig, o as resolveEffectiveEnableState } from "./config-state-DmPson1J.js";
import "./browser-config-runtime-Bjq5IxaH.js";
import { o as stopOpenClawChrome } from "./chrome-D1wjC_HZ.js";
import { n as listKnownProfileNames, t as createBrowserRouteContext } from "./server-context-a2_X6e09.js";
import { t as isPwAiLoaded } from "./pw-ai-state-B9y-HCvh.js";
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-DHJUNAep.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
