...
import { o as getResolvedLoggerSettings } from "./logger-CnaMaZPi.js";
...
import { l as normalizeTrimmedStringList, s as normalizeStringEntries } from "./string-normalization-DeXXoUde.js";
import { r as normalizeChatChannelId } from "./ids-ZUx9SnUD.js";
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-DtKxDfkA.js";
import { n as defaultRuntime } from "./runtime-Df11Xt6R.js";
import { t as sanitizeForLog } from "./ansi-lD0AkxvX.js";
import { t as isTruthyEnvValue$1 } from "./env-jndHmrmK.js";
import { C as CLAUDE_CLI_PROFILE_ID, g as resolveAuthStorePathForDisplay, n as ensureAuthProfileStore, y as readClaudeCliCredentialsCached } from "./store-C5g_fGOG.js";
import { n as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-CEJUfPLd.js";
import { $ as collectChannelDoctorStaleConfigMutations, B as normalizeCompatibilityConfigValues, L as findLegacyConfigIssues, Q as collectChannelDoctorRepairMutations, X as collectChannelDoctorMutableAllowlistWarnings, Y as collectChannelDoctorEmptyAllowlistExtraWarnings, Z as collectChannelDoctorPreviewWarnings, et as runChannelDoctorConfigSequences, h as writeConfigFile, it as listPluginDoctorLegacyConfigRules, l as readConfigFileSnapshot, nt as applyLegacyDoctorMigrations, rt as collectRelevantDoctorPluginIds, tt as shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning, x as validateConfigObjectWithPlugins } from "./io-B-YPX79V.js";
import { t as asNullableObjectRecord } from "./record-coerce-Da6QT2bI.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-DRnxzk1J.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-HZHKO_Jn.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-B4TpMTxm.js";
import { t as getBundledChannelPlugin } from "./bundled-CdLjswoh.js";
import { a as normalizeAnyChannelId } from "./registry-DR0Inr-7.js";
import { r as listChannelPlugins, t as getChannelPlugin } from "./registry-CAnQx2oU.js";
import { x as parseAgentSessionKey } from "./session-key-L2XsSJT_.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-DvNGLnmF.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-BckzHLk4.js";
import { i as listBundledChannelPluginIds } from "./bootstrap-registry-nPyF75ul.js";
import { b as resolveExecutablePath, i as normalizeTrustedSafeBinDirs, n as isTrustedSafeBinPath, o as listRiskyConfiguredSafeBins, p as resolveCommandResolutionFromArgv, t as getTrustedSafeBinDirs } from "./exec-safe-bin-trust-D5XXp4K4.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-xi_1oMVJ.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-_11V2h5W.js";
import { a as resolveAgentDir, h as resolveDefaultAgentId, m as resolveAgentWorkspaceDir } from "./agent-scope-C7LiYj5W.js";
import { a as normalizePluginsConfig, i as normalizePluginId, s as resolveEffectivePluginActivationState } from "./config-state-DmPson1J.js";
import "./config-M6t0-B38.js";
import { n as parseToolsBySenderTypedKey } from "./types.tools-D5GB3vKl.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-C0bmoNU_.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-rMc8VJBA.js";
import { t as hasBundledChannelPersistedAuthState } from "./persisted-auth-state-D0qlDl3A.js";
import { n as listPotentialConfiguredChannelIds } from "./config-presence-Bi1jPo3m.js";
import "./plugins-DB_0wnJl.js";
import "./logging-B8ph7hAz.js";
import { n as resolvePluginProviders } from "./providers.runtime-B72vPU6S.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-BAgVLJtj.js";
import { a as getModelRefStatus, d as resolveConfiguredModelRef, p as resolveHooksGmailModel } from "./model-selection-DP92S76A.js";
import { t as formatCliCommand } from "./command-format-CwCsVPsh.js";
import { d as resolveGatewayLaunchAgentLabel, g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-ijKGP-nu.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-DZOLBk0-.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-Cca7p8MV.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-EyF6btAb.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-vfSjNJ6A.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-K4d5EFCn.js";
import { a as isLoopbackHost, m as resolveGatewayBindHost } from "./net-BWcjOlSf.js";
import { o as resolveGatewayAuth } from "./auth-BbsY8q8P.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, u as resolveStorePath } from "./paths-CrHqfnMp.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-CoS4Cf-k.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BsTb2Has.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CHAt7baj.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-BW4xc3GM.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-CxvCJpMy.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-CHYP3VY0.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-CH-N7oyG.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-B7wX-Bmr.js";
import { a as formatRuntimeStatus, n as renderSystemdUnavailableHints, o as resolveDaemonContainerContext, r as buildPlatformRuntimeLogHints, t as isSystemdUnavailableDetail } from "./systemd-hints-V8vdjqcC.js";
import { n as formatConfigIssueLines } from "./issue-format-CAv_M0Bu.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-By9oAt8S.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BJ0MAicQ.js";
import { n as findExtraGatewayServices, r as renderGatewayServiceCleanupHints } from "./inspect-DIF7zVR9.js";
...
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-C9fVTDPs.js";
...
import { n as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-D6czjo8S.js";
import { i as resolveBootstrapContextForRun } from "./bootstrap-files-Z7VSltzH.js";
import { F as resolveBootstrapTotalMaxChars, N as resolveBootstrapMaxChars } from "./pi-embedded-helpers-BD0z98Ym.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-5VWdPuNX.js";
import { l as DEFAULT_SANDBOX_IMAGE, r as resolveSandboxScope, s as DEFAULT_SANDBOX_BROWSER_IMAGE } from "./config-Wg-U8Xdw.js";
import { s as resolveApiKeyForProvider } from "./model-auth-BcUEPfGz.js";
import { l as loadExecApprovals } from "./exec-approvals-BIBEOnML.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-BzHcsP5K.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-D-VNZ7sV.js";
import { a as DeliveryThreadIdFieldSchema, c as TrimmedNonEmptyStringFieldSchema, o as LowercaseNonEmptyStringFieldSchema, t as inferLegacyName, u as parseOptionalField } from "./normalize-EPqiG4LC.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BwuU9VQo.js";
import { i as listRouteBindings } from "./bindings-D_VpXXeM.js";
import { M as listTaskFlowRecords, d as listTasksForFlowId } from "./task-registry-C2FGQI1O.js";
import "./runtime-internal-x7c85ecO.js";
import "./sandbox-DwAoNjTH.js";
...
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-C4kNbgNg.js";
import { a as readChannelAllowFromStore } from "./pairing-store-EKDwEjkm.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-D_6CpFGk.js";
import { n as logConfigUpdated } from "./logging-Pix_Fh5f.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-Bkv-y2h-.js";
import { t as note$1 } from "./note-Bt_43r-N.js";
import { a as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as auditShortTermPromotionArtifacts, o as repairShortTermPromotionArtifacts, r as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-DmX97p6g.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-CA-xJSyB.js";
import "./engine-embeddings-l-YIrwde.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-r-xsDoD_.js";
import { t as checkQmdBinaryAvailability } from "./engine-qmd-Da03HIec.js";
import "./engine-storage-CdqE7lMP.js";
import "./secret-Dgh9g0e3.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dgs0_T-_.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-DzapNscc.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-nt90vpYy.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-83sG2rrw.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-NKEhSw32.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-Beixufqq.js";
import { r as healthCommand } from "./health-BKzChwSG.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-BwNen5BL.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Bl2YTPRu.js";
import { t as formatHealthCheckFailure } from "./health-format-_5oBkZuW.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-Dn4qrAZM.js";
import { a as runChannelPluginStartupMaintenance, i as normalizeCronJobIdentityFields, o as runGatewayUpdate, t as coerceFiniteScheduleNumber } from "./schedule-lV0Lqt3k.js";
import { n as doctorShellCompletion } from "./doctor-completion-f4e0QjSI.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-wg2sKXLj.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-BWvpUtHn.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-BfnLbuuK.js";
import "./doctor-state-migrations-CGnHzi6p.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-BRdgkVZ4.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = findLegacyConfigIssues(snapshot.parsed, snapshot.parsed, listPluginDoctorLegacyConfigRules({ pluginIds: collectRelevantDoctorPluginIds(snapshot.parsed) }));
