...
import { c as normalizeResolvedSecretInputString, i as coerceSecretRef } from "./types.secrets-B4TpMTxm.js";
...
import { o as isPrivateNetworkOptInEnabled, t as assertHttpUrlTargetsPrivateNetwork, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-B9ZyjgPE.js";
...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CeyRsGw5.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DAA6q2f1.js";
import { c as resolveMatrixBaseConfig, i as findMatrixAccountConfig, o as listNormalizedMatrixAccountIds, t as resolveMatrixConfigFieldPath } from "./config-paths-DjVNc5so.js";
import { t as getMatrixRuntime } from "./runtime-DrPmXjJB.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-QjksSeZA.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BhhN_JmS.js"), import("./logging-B-H1goKd.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-B5IdbrRi.js").then((credentialsReadModule) => ({
...
async function loadMatrixSecretInputDeps() {
	matrixSecretInputDepsPromise ??= import("./config-secret-input.runtime-D8VQSj1p.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString }));
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-BzsfqOQa.js");
...
async function backfillMatrixAuthDeviceIdAfterStartup(params) {
	...
	if (isAbortSignalTriggered(params.abortSignal)) return;
	return await (await import("./credentials-write.runtime-BzsfqOQa.js")).saveBackfilledMatrixDeviceId({
		homeserver: params.auth.homeserver,
		userId: params.auth.userId,
		accessToken: params.auth.accessToken,
		deviceId
