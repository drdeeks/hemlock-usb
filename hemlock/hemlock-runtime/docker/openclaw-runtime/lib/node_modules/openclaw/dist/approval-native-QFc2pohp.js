...
import { i as listTelegramAccountIds } from "./preview-streaming-DUriz1Tp.js";
import { a as normalizeTelegramChatId, r as parseTelegramThreadId, s as parseTelegramTarget } from "./outbound-params-Dbvx1hmC.js";
...
const telegramNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-CNfaJ3I6.js")).telegramApprovalNativeRuntime
	})
});
