...
import { x as readLoggingConfig } from "./logger-CnaMaZPi.js";
...
import { n as ensureAuthProfileStore, o as loadAuthProfileStoreForRuntime } from "./store-C5g_fGOG.js";
import { r as normalizeProviderId } from "./provider-id-Dts8rixb.js";
import { a as loadConfig, m as resolveConfigSnapshotHash, o as parseConfigJson5 } from "./io-B-YPX79V.js";
import { r as resolveManifestContractOwnerPluginId } from "./manifest-registry-DRnxzk1J.js";
import { o as normalizeChannelId } from "./registry-DR0Inr-7.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CAnQx2oU.js";
import { C as parseThreadSessionSuffix, c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey } from "./session-key-L2XsSJT_.js";
import { n as normalizeAccountId } from "./account-id-DvNGLnmF.js";
...
import { t as getProviderEnvVars } from "./provider-env-vars-CSnj2UxZ.js";
import { n as resolveAgentModelPrimaryValue, t as resolveAgentModelFallbackValues } from "./model-input-Deq97_rK.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-DQvpEApL.js";
import { t as logDebug } from "./logger-BYB3iw-K.js";
import { b as resolveSessionAgentIds, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, s as resolveAgentExecutionContract, y as resolveSessionAgentId } from "./agent-scope-C7LiYj5W.js";
import { t as parseDurationMs } from "./parse-duration-DRwx2zpl.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-CjWzlTp2.js";
import "./config-M6t0-B38.js";
import { f as resolveProfilesUnavailableReason, n as resolveAuthProfileOrder, o as getSoonestCooldownExpiry, s as isProfileInCooldown } from "./order-C0bmoNU_.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-BQpH8jex.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-B5nLJVpC.js";
import "./plugins-DB_0wnJl.js";
import { E as normalizeModelRef, T as modelKey, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString, n as buildConfiguredAllowlistKeys, t as buildAllowedModelSet } from "./model-selection-DP92S76A.js";
import { t as redactIdentifier } from "./redact-identifier-DQrgaT0p.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CrHqfnMp.js";
import { d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BHZEWLw5.js";
...
import { t as requireApiKey } from "./model-auth-runtime-shared-Du1UYXoT.js";
import { r as loadModelCatalog } from "./model-catalog-CiEGd-YZ.js";
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-c65bmCsP.js";
import { c as updateSessionStore } from "./store-Cw5RrVCw.js";
import { t as extractDeliveryInfo } from "./sessions-BWz-crFz.js";
import { n as resolveSessionConversationRef } from "./session-conversation-kTqh0NnS.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-OqD5syUc.js";
import { t as loadSessionStore } from "./store-load-DsLWM8wp.js";
import "./delivery-context-BGHNA3rL.js";
import { f as resolveSessionModelIdentityRef } from "./session-utils-DxZWUpMB.js";
import { l as jsonUtf8Bytes, n as capArrayByJsonBytes } from "./session-utils.fs-C8REwkJD.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-CIoRklU5.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-Ci7oOV2D.js";
import { w as textToSpeech } from "./tts-g32FpVk_.js";
import { E as isLikelyContextOverflowError, g as classifyProviderRuntimeFailureKind } from "./pi-embedded-helpers-BD0z98Ym.js";
import { i as parseApiErrorInfo } from "./assistant-error-format-DaK39TzJ.js";
import { d as stableStringify, o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-D2LemHTA.js";
import { C as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, D as describeSessionsSendTool, E as describeSessionsListTool, O as describeSessionsSpawnTool, S as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, T as describeSessionsHistoryTool, b as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, h as CRON_TOOL_DISPLAY_SUMMARY, k as describeUpdatePlanTool, v as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, w as describeSessionStatusTool, x as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, y as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DzEKj41v.js";
import { a as getImageMetadata } from "./image-ops-D6uof21W.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-DFYmurz4.js";
import { i as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-0k29xLnx.js";
import { c as listChannelSupportedActions, o as listAllChannelSupportedActions, r as resolvePluginTools } from "./tools-CtIcMWPU.js";
import { a as isTimeoutError, i as isFailoverError, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-BjoqUC62.js";
import { r as getApiKeyForModel } from "./model-auth-BcUEPfGz.js";
import { t as SsrFBlockedError } from "./ssrf-tCiyDHOt.js";
import { _ as toRelativeWorkspacePath, c as normalizeWorkspaceDir, l as resolveWorkspaceRoot, v as parseReplyDirectives } from "./deliver-CjBTircm.js";
import { t as extractTextFromChatContent } from "./chat-content-DK1XM9d6.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-BkBC0s0M.js";
import { t as extractAssistantText } from "./pi-embedded-utils-u_TX21Qm.js";
import { r as callGateway } from "./call-BzHcsP5K.js";
import { c as jsonResult, d as readNumberParam, h as readStringParam$1, o as imageResult, p as readStringArrayParam, r as ToolInputError, y as readSnakeCaseParamRaw } from "./common-BTJs9jR5.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BHo-A0Qi.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-x0_RgCMh.js";
import { a as trySafeFileURLToPath } from "./local-file-access-Bou0IAMB.js";
import { n as assertSandboxPath } from "./sandbox-paths-BsPbrjGT.js";
import { C as isAnnounceSkip, O as deliverSubagentAnnouncement, S as REPLY_SKIP_TOKEN, T as AGENT_LANE_NESTED, b as runAgentStep, d as registerSubagentRun, k as formatAgentInternalEventsForPrompt, w as isReplySkip, x as ANNOUNCE_SKIP_TOKEN } from "./subagent-registry-DK_dIom2.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-ARVv8hDR.js";
import { t as sendMessage } from "./message-DaDZ0Z0x.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BkUZAGi3.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BpNuwdhr.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-CEUDZK7h.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-DLlj7dYG.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-D5q2RDs1.js";
import { r as stripToolMessages } from "./chat-history-text-Bu-8AvWy.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DV1qp2CV.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-D7wwo2Vo.js";
import { c as TrimmedNonEmptyStringFieldSchema, l as parseDeliveryInput, s as TimeoutSecondsFieldSchema, t as inferLegacyName, u as parseOptionalField } from "./normalize-EPqiG4LC.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BwuU9VQo.js";
import { n as formatDoctorNonInteractiveHint, s as writeRestartSentinel } from "./restart-sentinel-BXSSW-hm.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-Bt7rOgat.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-CPxTyUOb.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-gkrP6ivc.js";
import { l as saveMediaBuffer } from "./store-CA7OW_2w.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BglnERA6.js";
import { r as getDefaultLocalRoots } from "./local-media-access-DaQPYiOO.js";
import { a as coerceImageModelConfig, c as buildToolModelConfigFromCandidates, d as hasToolModelConfig, f as resolveDefaultModelRef, l as coerceToolModelConfig, n as isMinimaxVlmProvider, o as decodeDataUrl, s as resolveProviderVisionModelFromConfig, u as hasAuthForProvider } from "./minimax-vlm-BaTCA1qQ.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-X4LkhWCY.js";
import { i as getMediaUnderstandingProvider } from "./entry-capabilities-BOg5J81N.js";
import { C as resolveBundledAutoMediaKeyProviders, S as bundledProviderSupportsNativePdfDocument, b as resolveAutoMediaKeyProviders, w as resolveBundledDefaultMediaModel, x as resolveDefaultMediaModel } from "./resolve-BsYWdFVt.js";
import { n as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-Dlju7Xfu.js";
import { t as buildProviderRegistry } from "./runner-BfRYetN-.js";
import "./media-understanding-bGVGc1zV.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-B64i6XC_.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CQYnY_2w.js";
import { r as sortWebFetchProvidersForAutoDetect } from "./web-fetch-providers.shared-BFKM-M97.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-DXnLNrED.js";
import { c as POLL_CREATION_PARAM_DEFS, l as SHARED_POLL_CREATION_PARAM_NAMES, n as runMessageAction, t as getToolResult } from "./message-action-runner-CtbsPp-L.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-BtHS36i1.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-CN7g8iuI.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-BsPGSBJW.js";
import { f as listTasksForOwnerKey } from "./task-registry-C2FGQI1O.js";
import "./runtime-internal-x7c85ecO.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, r as completeTaskRunByRunId, s as recordTaskRunProgressByRunId } from "./task-executor-iCllQvE8.js";
import "./task-registry-delivery-runtime-CKRmncBU.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-DeKkY2GE.js";
import { t as parseTimeoutMs } from "./parse-timeout-DGyBEH0B.js";
import { t as extractPdfContent } from "./pdf-extract-BQPFOwRi.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DC2W1N-r.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-DKoHMqWI.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-BlSb3qPs.js";
import { n as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-C2dZFj0-.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-DUZ6mzCf.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-7M8PLKfy.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-B_RNmiso.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-Dk_-bVs_.js";
import { c as wrapWebContent, s as wrapExternalContent } from "./external-content-Dvi5xKdO.js";
import { t as resolvePluginWebFetchProviders } from "./web-fetch-providers.runtime-CJQJ8uF-.js";
import { a as runWebSearch, c as readWebProviderEnvValue, i as resolveWebSearchDefinition, l as resolveWebProviderConfig, o as hasWebProviderEntryCredential, s as providerRequiresCredential, u as resolveWebProviderDefinition } from "./runtime-BQO1NZLq.js";
import { _ as truncateText$1, a as readResponseText, g as markdownToText, h as htmlToMarkdown, i as readCache, l as writeCache, m as extractReadableContent, o as resolveCacheTtlMs, p as extractBasicHtmlContent, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as fetchWithWebToolsNetworkGuard } from "./web-shared-BBogJkWw.js";
import "./web-search-provider-common-BuV6ZUdq.js";
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./commands-status.runtime-BpIUzQ78.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-D4KIX7RB.js");
