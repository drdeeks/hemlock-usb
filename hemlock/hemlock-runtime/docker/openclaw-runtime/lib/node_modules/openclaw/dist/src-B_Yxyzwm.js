...
import { x as buildMediaPayload } from "./reply-payload-C-MyOxXD.js";
...
import { r as resolveDefaultGroupPolicy } from "./runtime-group-policy-BUWwjQZ_.js";
...
import { a as resolveMSTeamsCredentials, s as resolveMSTeamsStorePath } from "./token-DdRku1C2.js";
import { t as getMSTeamsRuntime } from "./runtime-BMOryuuD.js";
import "./runtime-api-Cp9Bpn-4.js";
import { A as inferPlaceholder, B as safeHostForUrl, C as ATTACHMENT_TAG_RE, D as encodeGraphShareId, E as applyAuthorizationHeaderForUrl, F as readNestedString, I as resolveAttachmentFetchPolicy, L as resolveMediaSsrfPolicy, M as isLikelyImageAttachment, N as isUrlAllowed, O as extractHtmlFromAttachment, P as normalizeContentType, R as resolveRequestUrl, T as IMG_SRC_RE, V as tryBuildGraphSharesUrlForSharedLink, _ as buildUserAgent, a as fetchGraphJson, b as formatMSTeamsSendErrorHint, g as loadMSTeamsSdkWithAuth, h as createMSTeamsTokenProvider, j as isDownloadableAttachment, k as extractInlineImageCandidates, m as createMSTeamsAdapter, p as createBotFrameworkJwtValidator, v as ensureUserAgentHeader, w as GRAPH_ROOT, x as formatUnknownError, y as classifyMSTeamsSendError, z as safeFetchWithPolicy } from "./graph-users-4Edx4qdg.js";
import { a as resolveMSTeamsRouteConfig, f as resolveMSTeamsChannelAllowlist, i as resolveMSTeamsReplyPolicy, n as resolveMSTeamsAllowlistMatch, p as resolveMSTeamsUserAllowlist, t as isMSTeamsGroupAllowed } from "./policy-BWYXZqpS.js";
import { C as readJsonFile, S as createMSTeamsConversationStoreFs, T as writeJsonFile, _ as buildFileInfoCard, b as createMSTeamsPollStoreFs, c as renderReplyPayloadsToMessages, d as withRevokedProxyFallback, f as resolveGraphChatId, g as removePendingUploadFs, h as getPendingUploadFs, l as sendMSTeamsMessages, m as removePendingUpload, p as getPendingUpload, s as buildConversationReference, u as AI_GENERATED_ENTITY, v as parseFileConsentInvoke, w as withFileLock, x as extractMSTeamsPollVote, y as uploadToConsentUrl } from "./probe-BNqA0tMX.js";
