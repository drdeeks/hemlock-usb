...
import { s as hasOutboundReplyContent } from "./reply-payload-C-MyOxXD.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-Bzy0IwK_.js";
...
import { r as prefixSystemMessage } from "./system-message-X07G5MRV.js";
import { i as toAcpRuntimeError } from "./errors-DI8tIRID.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-DmUNNP3m.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-Dt1z76z8.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-4s4ohtgp.js";
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-Byi3L_AQ.js";
import { r as resolveAcpThreadSessionDetailLines } from "./session-identifiers-tQH0GGSL.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-ChD_n_3P.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-gIov_wUy.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-DLEo16O3.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-B-wIGu_Q.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-CFCfZHUc.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-DO6rEiE6.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-By0Yx-9F.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-Bpwv3kJF.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-B5m7abpg.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-CFCfZHUc.js");
