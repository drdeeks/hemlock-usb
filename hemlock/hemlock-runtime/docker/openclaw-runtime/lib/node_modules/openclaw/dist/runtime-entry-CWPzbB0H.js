...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-Cl0XNdRz.js";
import "./webhook-ingress-B4Mrq-gj.js";
import { t as zod_exports } from "./zod-ZpsmlbnP.js";
import "./api-BTCsSo8z.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-BdLIL6C_.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CpCDWa5T.js";
import { a as convertPcmToMulaw8k, t as isProviderStatusTerminal } from "./call-status-CIkXFRrL.js";
import { t as getHeader } from "./http-headers-ClvtHa9g.js";
...
var VoiceCallWebhookServer = class {
	...
	*/
	async initializeMediaStreaming() {
		...
		const { getRealtimeTranscriptionProvider, listRealtimeTranscriptionProviders } = await import("./realtime-transcription.runtime-B6RbaSAD.js");
...
async function resolveProvider(config) {
	...
	switch (config.provider) {
		case "telnyx": {
			const { TelnyxProvider } = await import("./telnyx-DCtjukxi.js");
		...
		case "twilio": {
			const { TwilioProvider } = await import("./twilio-D84Dl942.js");
		...
		case "plivo": {
			const { PlivoProvider } = await import("./plivo-C45nE0c7.js");
		...
		case "mock": {
			const { MockProvider } = await import("./mock-nFpcxX5B.js");
...
async function resolveRealtimeProvider(params) {
	const { getRealtimeVoiceProvider, listRealtimeVoiceProviders } = await import("./realtime-voice.runtime-Cbn-QIPX.js");
	const resolution = resolveConfiguredCapabilityProvider({
...
async function createVoiceCallRuntime(params) {
	...
	if (realtimeProvider) {
		const { RealtimeCallHandler } = await import("./realtime-handler-I4cwzcp5.js");
