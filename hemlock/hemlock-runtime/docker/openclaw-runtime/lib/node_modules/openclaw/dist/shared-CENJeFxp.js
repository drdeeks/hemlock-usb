...
import { a as resolveMatrixAuthContext, i as resolveMatrixAuth } from "./config-DzrMqyOz.js";
import { n as LogService } from "./logger-CpmkEoVS.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-DflZMtCx.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-1dYXoAue.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
