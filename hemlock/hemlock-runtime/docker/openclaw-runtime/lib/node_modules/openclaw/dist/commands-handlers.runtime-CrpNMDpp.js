...
import { s as normalizeStringEntries } from "./string-normalization-DeXXoUde.js";
...
import { t as clearPluginManifestRegistryCache } from "./manifest-registry-DRnxzk1J.js";
import { o as normalizeChannelId } from "./registry-DR0Inr-7.js";
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-CAnQx2oU.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-L2XsSJT_.js";
import { r as normalizeOptionalAccountId } from "./account-id-DvNGLnmF.js";
import { r as logVerbose } from "./globals-DQvpEApL.js";
import { a as resolveAgentDir, m as resolveAgentWorkspaceDir, y as resolveSessionAgentId } from "./agent-scope-C7LiYj5W.js";
import { t as parseDurationMs } from "./parse-duration-DRwx2zpl.js";
import "./config-M6t0-B38.js";
import { S as prepareProviderRuntimeAuth } from "./provider-runtime-B5nLJVpC.js";
import { n as resolveChannelApprovalCapability } from "./plugins-DB_0wnJl.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CEPnFgdQ.js";
import { d as resolveResponseUsageMode, l as normalizeUsageDisplay, o as normalizeFastMode } from "./thinking.shared-BZ7s87RR.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-CrHqfnMp.js";
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, o as isInternalMessageChannel } from "./message-channel-BHZEWLw5.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-D4SUGIkX.js";
...
import { o as resolveFreshSessionTotalTokens } from "./types-CpbhSLaW.js";
import { t as loadSessionStore } from "./store-load-DsLWM8wp.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-p2lxz2Ig.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DkO-EKt3.js";
import { t as diag } from "./diagnostic-V8lZDXn5.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-g32FpVk_.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-D6czjo8S.js";
...
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-DFYmurz4.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-Bx-dgEpK.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CipoAzdh.js";
import { r as callGateway } from "./call-BzHcsP5K.js";
import { a as createExecTool } from "./pi-tools-D36Y1JfN.js";
import { M as getSession, j as getFinishedSession } from "./bash-tools.exec-runtime-jfecOhNR.js";
import { i as resolveReplyToMode } from "./reply-threading-ZY94ykJe.js";
import { b as formatConfigWriteDeniedMessageShared, v as authorizeConfigWriteShared, x as resolveConfigWriteTargetFromPathShared, y as canBypassConfigWritePolicyShared } from "./channel-config-helpers-DQ2y7w8c.js";
import { t as formatDurationCompact } from "./format-duration-BYPZ9lFZ.js";
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-Bt7rOgat.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-BsPGSBJW.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-CU8RMdxt.js";
import "./sandbox-DwAoNjTH.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-BsMojl-5.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-Dx8aBFIu.js";
import { n as estimateTokensFromChars } from "./cjk-chars-L6KwCm6T.js";
import { r as resolveModelWithRegistry } from "./model-CPrqtDbi.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-DfFyjwfl.js";
import { t as isApprovalNotFoundError } from "./approval-errors-BzMxIWpa.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CO8Rj16_.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CxRNYZoP.js";
import "./commands-registry-DxeiLwP6.js";
import { n as formatTimeAgo } from "./format-relative-wfVso1Md.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-BimfLHao.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DEgb86By.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-EKDwEjkm.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-BBkA8j5I.js";
import { l as resolveArchiveKind } from "./archive-DJa810xe.js";
import { n as parseActivationCommand } from "./group-activation-DE-s16nb.js";
...
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-D-3kYXoB.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-Di6sblwn.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-S_TSFZmD.js";
import { t as extractBtwQuestion } from "./btw-command-VU-N45CN.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-C7xAWCgh.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-d5ZV42AI.js";
import { t as handleAcpCommand } from "./commands-acp-BCKlMq-t.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-C2y6MhzF.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CIoe-VR6.js";
import { r as handleModelsCommand } from "./commands-models-DgtNKT2D.js";
import { n as setPluginEnabledInConfig } from "./enable-D0UfQ7-l.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-BFDU2xds.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-Fl99MjWg.js";
import { n as buildToolsMessage } from "./status-Dx0BVy0c.js";
import { t as parseConfigValue } from "./config-value-BO9PBrlu.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-qsV_H0jX.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-DoBymwET.js";
import { i as listTasksForSessionKeyForStatus, r as listTasksForAgentIdForStatus, t as buildStatusReply } from "./commands-status-BXhxnGlm.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-CRfgGhyT.js";
import { m as parseClawHubPluginSpec } from "./clawhub-t8tftw_j.js";
import { r as installPluginFromClawHub } from "./clawhub-BT_iLcnB.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-nt90vpYy.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-CE_pA9Ht.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-Smgwxty0.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-DGZ0uXLW.js");
		killProcessTree(pid);
...
const handleCompactCommand = async (params) => {
	...
	const runtime = await import("./commands-compact.runtime-B9sMSLzP.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-B25vESep.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-B8Zojsvq.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-Ctzqeuto.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-CcH8kRt_.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-6qkl6HZm.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-hW_MQsgR.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-CarYXwvN.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-BeY1SQQh.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-CzWYvhvT.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-Dfpqxb84.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-DwQH0ymD.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-MEbc6WZN.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-CY1lUMms.js");
