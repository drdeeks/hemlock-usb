...
import { _ as collectUnsupportedSecretRefPolicyIssues, l as readConfigFileSnapshot, y as validateConfigObjectRaw } from "./io-B-YPX79V.js";
import { t as isBlockedObjectKey } from "./prototype-keys-DUbmvR-m.js";
import { t as CONFIG_PATH } from "./paths-HZHKO_Jn.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-B4TpMTxm.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-CG9Ki9BF.js";
import { w as SecretProviderSchema } from "./zod-schema.core-BDAfl8B8.js";
import { n as info, o as success, t as danger } from "./globals-DQvpEApL.js";
import { r as replaceConfigFile } from "./config-M6t0-B38.js";
import { a as resolveSecretRefValue } from "./resolve-DiXsmEpb.js";
import { t as formatCliCommand } from "./command-format-CwCsVPsh.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CAv_M0Bu.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-BpX2EZ01.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-HP9KKAMz.js";
import { n as setCommandJsonMode } from "./json-mode-MwYs3PK2.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-Bqczk-GF.js");
