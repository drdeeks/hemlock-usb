...
import { i as openBoundaryFileSync, r as openBoundaryFile } from "./boundary-file-read-C2FDLxpR.js";
import { l as isRecord, m as resolveUserPath, x as isPlainObject } from "./utils-D5DtWkEu.js";
import { t as createSubsystemLogger } from "./subsystem-D2gFnOcq.js";
import { r as normalizeProviderId } from "./provider-id-Dts8rixb.js";
import { at as resolveOwnerDisplaySetting } from "./io-B-YPX79V.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-DRnxzk1J.js";
import { i as normalizeChannelId } from "./registry-CAnQx2oU.js";
import { b as isSubagentSessionKey, y as isCronSessionKey } from "./session-key-L2XsSJT_.js";
...
import { b as resolveSessionAgentIds, y as resolveSessionAgentId } from "./agent-scope-C7LiYj5W.js";
import { a as normalizePluginsConfig, s as resolveEffectivePluginActivationState } from "./config-state-DmPson1J.js";
import { t as parseDurationMs } from "./parse-duration-DRwx2zpl.js";
import { p as sanitizeForConsole } from "./order-C0bmoNU_.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-BPEiUrBJ.js";
import { B as resolveProviderTransportTurnStateWithPlugin, F as resolveProviderRuntimePlugin, K as sanitizeProviderReplayHistoryWithPlugin, R as resolveProviderSystemPromptContribution, S as prepareProviderRuntimeAuth, U as resolveProviderWebSocketSessionPolicyWithPlugin, X as validateProviderReplayTurnsWithPlugin, Y as transformProviderSystemPrompt, k as resolveProviderCacheTtlEligibility, tt as wrapStreamFnTextTransforms, z as resolveProviderTextTransforms } from "./provider-runtime-B5nLJVpC.js";
import { u as getCompactionProvider } from "./loader-b5gxFmeZ.js";
import "./plugins-DB_0wnJl.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BfihYtV2.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CEPnFgdQ.js";
import "./model-selection-DP92S76A.js";
import { t as rawDataToString } from "./ws-BRmHzU5W.js";
import { d as normalizeMessageChannel } from "./message-channel-BHZEWLw5.js";
import { a as normalizeInputProvenance, n as applyInputProvenanceToUserMessage, r as hasInterSessionUserProvenance } from "./input-provenance-DBAnocn4.js";
...
import { c as createExpiringMapCache, d as resolveCacheTtlMs, u as isCacheEnabled } from "./store-cache-BZo-s8lH.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CUasLUvU.js";
import { d as resolveGatewaySessionStoreTarget } from "./session-utils-DxZWUpMB.js";
import { l as makeZeroUsageSnapshot, u as normalizeUsage } from "./chat-envelope-DGarBiZe.js";
import { a as normalizeAssistantPhase, o as parseAssistantTextSignature, t as encodeAssistantTextSignature } from "./chat-message-content-Dx0WxJrY.js";
import { i as resolveContextWindowInfo } from "./context-window-guard-BaVMyzQD.js";
import { a as isSilentReplyText } from "./tokens-CIoRklU5.js";
import { s as stripHeartbeatToken } from "./heartbeat-B5UCaFTR.js";
import { t as resolveAccountEntry } from "./account-lookup-gj7vcoJz.js";
...
import { i as resolveBootstrapContextForRun, o as resolveHeartbeatPromptForSystemPrompt, r as makeBootstrapWarn } from "./bootstrap-files-Z7VSltzH.js";
import { I as sanitizeGoogleTurnOrdering, M as ensureSessionHeader, c as extractToolCallsFromAssistant, d as downgradeOpenAIFunctionCallReasoningPairs, f as downgradeOpenAIReasoningBlocks, l as extractToolResultId, n as validateGeminiTurns, p as isGoogleModelApi, r as pickFallbackThinkingLevel, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns } from "./pi-embedded-helpers-BD0z98Ym.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-1pziCGe0.js";
...
import { a as isTimeoutError } from "./failover-error-BjoqUC62.js";
import { t as buildModelAliasLines } from "./model-alias-lines-HDkUH1mU.js";
import { c as resolveModelAuthMode, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-BcUEPfGz.js";
import { a as logProviderToolSchemaDiagnostics, i as shouldUseOpenAIWebSocketTransport, o as normalizeProviderToolSchemas, s as supportsModelTools } from "./attempt.thread-helpers-pPeqJHno.js";
import { a as createBoundaryAwareStreamFnForModel, c as mergeTransportMetadata, d as normalizeOpenAIStrictToolParameters, f as resolveOpenAIStrictToolFlagForInventory, n as registerProviderStreamForModel, p as resolveOpenAIStrictToolSetting, t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-Doy9whjL.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-BIHuBcHI.js";
import { i as getModelProviderRequestTransport, l as resolveProviderRequestPolicyConfig, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-CJHK-93o.js";
import { t as log$4 } from "./logger-4EfpsAw2.js";
import { b as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-BGERMs0W.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-B6zvhybg.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-BgZEJW46.js";
import { a as loadEmbeddedPiMcpConfig, o as describeStdioMcpServerLaunchConfig, s as resolveStdioMcpServerLaunchConfig, t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-tools-acACZGZo.js";
import { t as collectTextContentBlocks } from "./content-blocks-B5Ft6c22.js";
import { c as jsonResult, u as payloadTextResult } from "./common-BTJs9jR5.js";
import { n as isToolWrappedWithBeforeToolCallHook, r as runBeforeToolCallHook } from "./pi-tools.before-tool-call-CXO7TUbf.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DSR7qq_Y.js";
import { t as createOpenClawCodingTools } from "./pi-tools-D36Y1JfN.js";
import { i as generateSecureToken } from "./secure-random-CsODx7RS.js";
import { n as detectRuntimeShell } from "./supervisor-Cvk622m_.js";
import { c as resolveSkillsPromptForRun, s as loadWorkspaceSkillEntries } from "./skills-B5qdBn1G.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DqXzHel5.js";
import { o as resolveSandboxContext } from "./sandbox-DwAoNjTH.js";
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-CM8F_irR.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-BsMojl-5.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-D3UYv6Rv.js";
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-DXG3PBat.js";
import { h as shouldPreserveThinkingBlocks } from "./provider-model-shared-pqO3tDFY.js";
import { n as isAnthropicFamilyCacheTtlEligible, r as isAnthropicModelRef } from "./anthropic-cache-control-payload-Ba6jkPFY.js";
import { i as isGooglePromptCacheEligible, t as applyExtraParamsToAgent } from "./extra-params-OIS_uVi7.js";
import { t as withTimeout } from "./with-timeout-XnflBimJ.js";
import { n as resolveCronStyleNow } from "./current-time-DZdq-swh.js";
import { n as retryAsync } from "./retry-BQn5Qrea.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-BIIUF8cG.js";
import "./query-CExQ3O6g.js";
import { r as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-D1HfWIw9.js";
import { t as estimateStringChars } from "./cjk-chars-L6KwCm6T.js";
...
import { n as getActiveMemorySearchManager } from "./memory-runtime-DHcuNami.js";
...
import { DefaultResourceLoader, SessionManager, SettingsManager, createAgentSession, estimateTokens, generateSummary } from "@mariozechner/pi-coding-agent";
...
async function sanitizeSessionHistory(params) {
	...
	const sanitizedCompactionUsage = ensureAssistantUsageSnapshots(stripStaleAssistantUsageBeforeLatestCompaction(stripToolResultDetails(policy.repairToolUseResultPairing ? sanitizeToolUseResultPairing(sanitizedToolCalls, { erroredAssistantResultPolicy: "drop" }) : sanitizedToolCalls)));
	...
	const sanitizedOpenAI = isOpenAIResponsesApi ? downgradeOpenAIFunctionCallReasoningPairs(downgradeOpenAIReasoningBlocks(sanitizedCompactionUsage)) : sanitizedCompactionUsage;
...
async function hardenManualCompactionBoundary(params) {
	...
	await fs$1.writeFile(tmpFile, content, "utf-8");
	await fs$1.rename(tmpFile, params.sessionFile);
...
async function truncateSessionAfterCompaction(params) {
	...
	try {
		...
		log$4.warn(`[session-truncation] Failed to open session file: ${reason}`);
		return {
			truncated: false,
			entriesRemoved: 0,
			reason
	...
	let bytesBefore = 0;
	try {
		bytesBefore = (await fs$1.stat(sessionFile)).size;
	} catch {}
	if (params.archivePath) try {
		const archiveDir = path.dirname(params.archivePath);
		await fs$1.mkdir(archiveDir, { recursive: true });
		await fs$1.copyFile(sessionFile, params.archivePath);
		log$4.info(`[session-truncation] Archived pre-truncation file to ${params.archivePath}`);
	} catch (err) {
		const reason = formatErrorMessage(err);
		log$4.warn(`[session-truncation] Failed to archive: ${reason}`);
	}
	const content = [JSON.stringify(header), ...keptEntries.map((e) => JSON.stringify(e))].join("\n") + "\n";
	const tmpFile = `${sessionFile}.truncate-tmp`;
	try {
		await fs$1.writeFile(tmpFile, content, "utf-8");
		await fs$1.rename(tmpFile, sessionFile);
	} catch (err) {
		try {
			await fs$1.unlink(tmpFile);
		} catch {}
		const reason = formatErrorMessage(err);
		log$4.warn(`[session-truncation] Failed to write truncated file: ${reason}`);
		return {
			truncated: false,
			entriesRemoved: 0,
			reason
	...
	log$4.info(`[session-truncation] Truncated session file: entriesBefore=${totalEntriesBefore} entriesAfter=${keptEntries.length} removed=${entriesRemoved} bytesBefore=${bytesBefore} bytesAfter=${bytesAfter} reduction=${bytesBefore > 0 ? ((1 - bytesAfter / bytesBefore) * 100).toFixed(1) : "?"}%`);
	return {
		truncated: true,
		entriesRemoved,
		bytesBefore,
...
async function compactEmbeddedPiSessionDirect(params) {
	...
	try {
		...
		try {
			...
			if (shouldUseWebSocketTransport && !wsApiKey) log$4.warn(`[ws-stream] no API key for provider=${provider}; keeping compaction HTTP transport`);
			while (true) {
				...
				try {
					...
					if (!containsRealConversationMessages(session.messages)) {
						log$4.info(`[compaction] skipping — no real conversation messages (sessionKey=${params.sessionKey ?? params.sessionId})`);
						return {
							ok: true,
							compacted: false,
					...
					if (params.trigger === "manual") try {
						...
						log$4.warn("[compaction] failed to harden manual compaction boundary", { errorMessage: formatErrorMessage(err) });
					}
					...
					if (params.config && params.sessionKey && checkpointSnapshot) try {
						...
						log$4.warn("failed to persist compaction checkpoint", { errorMessage: formatErrorMessage(err) });
					}
					...
					if (params.config?.agents?.defaults?.compaction?.truncateAfterCompaction) try {
						...
						if (truncResult.truncated) log$4.info(`[compaction] post-compaction truncation removed ${truncResult.entriesRemoved} entries (sessionKey=${params.sessionKey ?? params.sessionId})`);
					} catch (err) {
						log$4.warn("[compaction] post-compaction truncation failed", {
							errorMessage: formatErrorMessage(err),
							errorStack: err instanceof Error ? err.stack : void 0
						});
					}
					...
					if (fallbackThinking) {
						log$4.warn(`[compaction] request rejected for ${provider}/${modelId}; retrying with ${fallbackThinking}`);
...
//#endregion
export { listSessionCompactionCheckpoints as $, estimateMessagesTokens as A, truncateOversizedToolResultsInSessionManager as B, validateReplayTurns as C, buildEmbeddedExtensionFactories as D, limitHistoryTurns as E, resolveTranscriptPolicy as F, createBundleLspToolRuntime as G, repairSessionFileIfNeeded as H, guardSessionManager as I, resolveChannelCapabilities as J, releaseWsSession as K, estimateToolResultReductionPotential as L, resolveCompactionTimeoutMs as M, isCacheTtlEligibleProvider as N, dropThinkingBlocks as O, readLastCacheTtlTimestamp as P, getSessionCompactionCheckpoint as Q, sessionLikelyHasOversizedToolResults as R, sanitizeSessionHistory as S, getDmHistoryLimitFromSessionKey as T, toClientToolDefinitions as U, installToolResultContextGuard as V, createPreparedEmbeddedPiSettingsManager as W, captureCompactionCheckpointSnapshot as X, filterHeartbeatPairs as Y, cleanupCompactionCheckpointSnapshot as Z, resolveEmbeddedAgentBaseStreamFn as _, runPostCompactionSideEffects as a, prewarmSessionFile as b, flushPendingToolResultsAfterIdle as c, collectAllowedToolNames as d, persistSessionCompactionCheckpoint as et, applySystemPromptOverrideToSession as f, resolveEmbeddedAgentApiKey as g, describeEmbeddedAgentStreamStrategy as h, asCompactionHookRunner as i, readPostCompactionContext as j, SAFETY_MARGIN as k, mapThinkingLevel as l, createSystemPromptOverride as m, compactEmbeddedPiSessionDirect as n, buildEmbeddedCompactionRuntimeContext as o, buildEmbeddedSystemPrompt as p, buildStreamErrorAssistantMessage as q, readPiModelContextTokens as r, resolveEmbeddedCompactionTarget as s, __testing as t, resolveSessionCompactionCheckpointReason as tt, splitSdkTools as u, resolveEmbeddedAgentStreamFn as v, buildEmbeddedMessageActionDiscoveryInput as w, trackSessionManagerAccess as x, resolveEmbeddedRunSkillEntries as y, truncateOversizedToolResultsInSession as z };
