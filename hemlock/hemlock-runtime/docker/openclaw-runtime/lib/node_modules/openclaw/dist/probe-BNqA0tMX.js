...
import { i as withFileLock$1 } from "./file-lock-D0aN8mKy.js";
...
import { F as readNestedString, S as isRevokedProxyError, _ as buildUserAgent, b as formatMSTeamsSendErrorHint, f as readAccessToken, g as loadMSTeamsSdkWithAuth, h as createMSTeamsTokenProvider, m as createMSTeamsAdapter, x as formatUnknownError, y as classifyMSTeamsSendError } from "./graph-users-4Edx4qdg.js";
...
async function probeMSTeams(cfg) {
	...
	try {
		...
		if (cfg?.delegatedAuth?.enabled) try {
			const { loadDelegatedTokens } = await import("./token-Co9i93AS.js");
