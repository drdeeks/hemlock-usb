import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-D8p6rxH8.js";
...
import { i as getChildLogger } from "./logger-CnaMaZPi.js";
import { t as createNonExitingRuntime } from "./runtime-Df11Xt6R.js";
import { t as createSubsystemLogger } from "./subsystem-D2gFnOcq.js";
import { a as loadConfig, h as writeConfigFile } from "./io-B-YPX79V.js";
import { _ as resolveStateDir } from "./paths-HZHKO_Jn.js";
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-L2XsSJT_.js";
import { n as normalizeAccountId } from "./account-id-DvNGLnmF.js";
import { r as getRuntimeConfigSnapshot } from "./runtime-snapshot-YFfeLl-m.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-DQvpEApL.js";
import { a as resolveAgentDir, h as resolveDefaultAgentId } from "./agent-scope-C7LiYj5W.js";
import { s as getPluginCommandSpecs } from "./command-registration-Bmks-tEe.js";
import { t as createDedupeCache } from "./dedupe-DvG9Uaxi.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CEPnFgdQ.js";
import { f as resolveDefaultModelForAgent } from "./model-selection-DP92S76A.js";
import { u as resolveStorePath } from "./paths-CrHqfnMp.js";
import { a as modelSupportsVision, n as findModelInCatalog, r as loadModelCatalog } from "./model-catalog-CiEGd-YZ.js";
import { t as resolveAckReaction } from "./identity-LLtDOuch.js";
import { a as resolveSessionStoreEntry, c as updateSessionStore } from "./store-Cw5RrVCw.js";
...
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-C-MyOxXD.js";
import { c as stripReasoningTagsFromText, d as isInsideCode, u as findCodeRegions } from "./assistant-visible-text-BkBC0s0M.js";
import { o as formatReasoningMessage } from "./pi-embedded-utils-u_TX21Qm.js";
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-BhpFcpTV.js";
import { r as enqueueSystemEvent } from "./system-events-BwxCjOwe.js";
import { i as resolveChannelStreamingBlockEnabled } from "./channel-streaming-IuoO4Iuj.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-BJOSq3sp.js";
import { f as fireAndForgetHook, i as toInternalMessageReceivedContext } from "./message-hook-mappers-CIPnjy6o.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-YqA7ta9g.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-ARVv8hDR.js";
import { g as resolveChannelConfigWrites } from "./channel-config-helpers-DQ2y7w8c.js";
import { t as loadWebMedia } from "./web-media-BglnERA6.js";
import { t as MediaFetchError } from "./fetch-B85tpt48.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-C1CfL-zm.js";
import { r as getSessionBindingService } from "./session-binding-service-DT1c886h.js";
...
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval, u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-cW8wOesi.js";
import "./error-runtime-Da0X1TOQ.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CO8Rj16_.js";
import { n as isAbortRequestText } from "./abort-primitives-CxRNYZoP.js";
import { t as hasControlCommand } from "./command-detection-DNYq9uM-.js";
import { c as parseCommandArgs, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-DxeiLwP6.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-l34d7rAH.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-BPLQYvZo.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-BimfLHao.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-Bq4ctOM5.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-C6cfBJ7w.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-DYM2M_v6.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-DUv0CJhz.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-BYk02T3e.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-EKDwEjkm.js";
import { t as firstDefined } from "./allow-from-CLVRAVJR.js";
import { a as buildPendingHistoryContextFromMap, s as clearHistoryEntriesIfEnabled, u as recordPendingHistoryEntryIfEnabled } from "./history-C4oWdkP5.js";
import "./reply-history-DF6Lm0Ia.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-sOwyEnNl.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-CJZpAxBU.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-rPdRacuP.js";
import "./runtime-env-DLaqJQah.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-resolver-CwRYzd4d.js";
import "./approval-gateway-runtime-DroRImHs.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-YnM4GZpy.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-BpCxpfZ-.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled, t as isNativeCommandsExplicitlyDisabled } from "./commands-BA4r10J2.js";
import "./config-runtime-Hrpwdk2u.js";
import { t as resolveCommandAuthorization } from "./command-auth-K6v9wqMC.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-sRSYqmhj.js";
import { n as isBtwRequestText } from "./btw-command-VU-N45CN.js";
import { t as generateConversationLabel } from "./reply-runtime-B2AVTFFN.js";
import "./reply-dispatch-runtime-D_wVdcyg.js";
import "./reply-chunking-Bt55O3Yu.js";
import "./web-media-BErkJWj2.js";
import "./infra-runtime-DENIjfhx.js";
import "./media-runtime-_5B9mz0A.js";
import { n as resolveConfiguredBindingRoute } from "./binding-routing-eDy9xc8N.js";
import "./conversation-runtime-Du8VNJpk.js";
import { d as resolveThreadBindingSpawnPolicy, l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-nl9ZOgzR.js";
import "./agent-runtime-Lvb71pCH.js";
import { n as createInteractiveConversationBindingHelpers, t as dispatchPluginInteractiveHandler } from "./plugin-runtime-C42rLU84.js";
import "./security-runtime-CEMag8SV.js";
import "./hook-runtime-DlfBzXYT.js";
import "./markdown-table-runtime-VC5FVw5X.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-C2y6MhzF.js";
import "./command-auth-BNI2Gxd-.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-B_61jtXF.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CIoe-VR6.js";
import { n as formatModelsAvailableHeader, t as buildModelsProviderData } from "./commands-models-DgtNKT2D.js";
import "./command-auth-native-DlYYfEnp.js";
import "./command-status-Cd4LHvEb.js";
import "./command-detection-npR9TL8c.js";
import "./command-surface-BkoJnAcq.js";
import { n as DEFAULT_EMOJIS } from "./channel-feedback-BOu7f9EX.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-B3GLEQYw.js";
import { n as toLocationContext, t as formatLocationText } from "./location-PH3K-Nk3.js";
import { i as createFinalizableDraftLifecycle } from "./channel-lifecycle-BUPkkNyV.js";
import "./state-paths-CbpNmxcu.js";
import "./models-provider-runtime-CrHpZTyk.js";
import "./skill-commands-runtime-DBxi55ja.js";
import { c as resolveTelegramAccount, u as resolveTelegramMediaRuntimeOptions } from "./preview-streaming-DUriz1Tp.js";
import { t as normalizeTelegramReplyToMessageId } from "./outbound-params-Dbvx1hmC.js";
import { r as resolveTelegramTransport } from "./fetch-DG_yrNjU.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DPsqdGY2.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-BmQu-wgv.js";
import { A as withResolvedTelegramForumFlag, B as isSenderAllowed, C as resolveTelegramDirectPeerId, E as resolveTelegramGroupAllowFromContext, F as getTelegramTextParts, H as normalizeDmAllowFromWithStore, I as hasBotMention, L as normalizeForwardedContext, M as buildSenderName, N as expandTextLinks, O as resolveTelegramStreamMode, P as extractTelegramLocation, S as extractTelegramForumFlag, T as resolveTelegramForumThreadId, U as resolveSenderAllowMatch, V as normalizeAllowFrom, _ as buildTelegramParentPeer, b as buildTypingThreadParams, c as isSafeToRetrySendError, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as buildSenderLabel, k as resolveTelegramThreadSpec, l as isTelegramClientRejection, m as buildGroupLabel, p as tagTelegramNetworkError, s as isRecoverableTelegramNetworkError, v as buildTelegramRoutingTarget, w as resolveTelegramForumFlag, x as describeReplyTarget, y as buildTelegramThreadParams, z as resolveTelegramPrimaryMedia } from "./format-Bn9StMOQ.js";
import { c as buildModelsKeyboard, d as getModelsPageSize, f as parseModelCallbackData, l as buildProviderKeyboard, p as resolveModelSelection, t as buildCommandsPaginationKeyboard, u as calculateTotalPages } from "./command-ui-BTbk5BJR.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-BH1sm6d6.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-D729PfIb.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-BDN0YEDY.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-BMEO7ApZ.js";
import { _ as wasSentByBot, a as editMessageTelegram, b as withTelegramApiErrorLogging, g as recordSentMessage, v as buildInlineKeyboard } from "./send-BiMhsZ2r.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DlyxeD_-.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-D4o8ZHN1.js");
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-24JS4odO.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-C5FUZ5KA.js");
...
async function resolveStickerVisionSupport$1(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-BUoZ7hlh.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (hasAudio && !hasUserText && (!isGroup || requireMention && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight)) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-CZXqj3fb.js");
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-PmqnHTYY.js");
