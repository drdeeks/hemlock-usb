...
import { v as resolveRunModelFallbacksOverride, y as resolveSessionAgentId } from "./agent-scope-C7LiYj5W.js";
import "./config-M6t0-B38.js";
import { g as resolveMemoryFlushPlan } from "./memory-state-CXPHU_bG.js";
import { d as resolveResponseUsageMode, u as normalizeVerboseLevel } from "./thinking.shared-BZ7s87RR.js";
import { S as isCliProvider } from "./model-selection-DP92S76A.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-CrHqfnMp.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-BHZEWLw5.js";
import { S as resolveGroupSessionKey, c as updateSessionStore, l as updateSessionStoreEntry } from "./store-Cw5RrVCw.js";
import "./sessions-BWz-crFz.js";
import { o as resolveFreshSessionTotalTokens, s as resolveSessionPluginDebugLines } from "./types-CpbhSLaW.js";
import { t as loadSessionStore } from "./store-load-DsLWM8wp.js";
import { n as resolveContextTokensForModel } from "./context-DZxBSnX2.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-p2lxz2Ig.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-DGarBiZe.js";
import { i as readSessionMessages } from "./session-utils.fs-C8REwkJD.js";
import { A as estimateMessagesTokens, j as readPostCompactionContext } from "./compact-g-BGaE4t.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-Do9ynpdK.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-JOCs7lw4.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-CIoRklU5.js";
import { s as stripHeartbeatToken } from "./heartbeat-B5UCaFTR.js";
import { a as isAudioFileName } from "./mime-Ci7oOV2D.js";
import { c as isLikelyExecutionAckPrompt, t as runEmbeddedPiAgent } from "./pi-embedded-runner-DXh-tqVs.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-D6czjo8S.js";
import { C as isContextOverflowError, E as isLikelyContextOverflowError, O as isTransientHttpError, S as isCompactionFailureError } from "./pi-embedded-helpers-BD0z98Ym.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-5VWdPuNX.js";
import { t as BILLING_ERROR_USER_MESSAGE, u as sanitizeUserFacingText, v as isBillingErrorMessage, x as isRateLimitErrorMessage, y as isOverloadedErrorMessage } from "./sanitize-user-facing-text-D2LemHTA.js";
import { n as resolveSandboxConfigForAgent } from "./config-Wg-U8Xdw.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BuMB4mti.js";
import { c as resolveModelAuthMode } from "./model-auth-BcUEPfGz.js";
import { h as resolvePathFromInput, v as parseReplyDirectives } from "./deliver-CjBTircm.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-C-MyOxXD.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-BrSNDEDb.js";
import { c as runWithModelFallback, l as LiveSessionModelSwitchError, s as isFallbackSummaryError } from "./openclaw-tools-C-4xhzGY.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-OtM2z7YX.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-BsPbrjGT.js";
import { a as generateSecureUuid } from "./secure-random-CsODx7RS.js";
...
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-BNHMLGcK.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-ZY94ykJe.js";
import { u as saveMediaSource } from "./store-CA7OW_2w.js";
import { i as scheduleFollowupDrain, t as enqueueFollowupRun } from "./queue-AttL4x6M.js";
import { s as refreshQueuedFollowupSession } from "./settings-runtime-BlEQlb9I.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DNeIlBgI.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-CU8RMdxt.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-DwAoNjTH.js";
import "./pi-embedded-HwLIt9IG.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-Bkv-y2h-.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-4s4ohtgp.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DWg-uFVJ.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-DVv_P1jp.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-CC0iw0JL.js";
import { i as resolveFallbackTransition, n as buildFallbackNotice, t as buildFallbackClearedNotice } from "./fallback-state-BRPBP7PJ.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-BFDU2xds.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-gIov_wUy.js";
import { n as incrementCompactionCount } from "./session-updates-BDM11jn5.js";
...
async function compactEmbeddedPiSessionDefault(...args) {
	const { compactEmbeddedPiSession } = await import("./pi-embedded-Dz44yzV5.js");
	return await compactEmbeddedPiSession(...args);
}
async function runEmbeddedPiAgentDefault(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded-Dz44yzV5.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-Cu59H8AW.js");
