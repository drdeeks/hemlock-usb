...
import { h as MarkdownConfigSchema, i as ContextVisibilityModeSchema, l as GroupPolicySchema } from "./zod-schema.core-BDAfl8B8.js";
import { i as buildNestedDmConfigSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-CZtpPFHc.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-DvNGLnmF.js";
import { s as ToolPolicySchema } from "./zod-schema.agent-runtime-DSIwhzzv.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-bXrpGuZ5.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate, n as ToolAuthorizationError } from "./common-BTJs9jR5.js";
import { c as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-DQ2y7w8c.js";
import "./text-runtime-3VPC1sGh.js";
import { n as describeAccountSnapshot } from "./account-helpers-BRpBAbGJ.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-CiylCX3L.js";
import { r as createChatChannelPlugin, t as buildChannelOutboundSessionRoute } from "./core-DaNQJg_E.js";
import "./channel-core-DnL1WWaZ.js";
import { r as buildSecretInputSchema } from "./secret-input-Kpl7BYxE.js";
import "./channel-config-schema-CGOpae00.js";
import { C as projectAccountConfigWarningCollector, g as createAllowlistProviderOpenWarningCollector } from "./channel-policy-no84IHKf.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-BcseZZYc.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-CunFJpR8.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BP8-nbbZ.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Csb7hAJZ.js";
import { t as extractToolSend } from "./tool-send-Ds6SE8VW.js";
import { n as formatPluginInstallPathIssue, t as detectPluginInstallPathIssue } from "./plugin-install-path-warnings-c_orFYZi.js";
import { t as removePluginFromConfig } from "./uninstall-CYb1xFFf.js";
import "./runtime-doctor-C8aJw_BM.js";
import "./config-runtime-Hrpwdk2u.js";
import "./outbound-runtime--HEvGZCa.js";
import "./conversation-runtime-Du8VNJpk.js";
import { t as chunkTextForOutbound } from "./text-chunking-0u8YTMbf.js";
import { r as buildTrafficStatusSummary } from "./extension-shared-Cb6KUw5K.js";
import "./channel-config-primitives-DJnSvVzJ.js";
import "./channel-status-D_X-Zkpl.js";
import { t as zod_exports } from "./zod-ZpsmlbnP.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-CeyRsGw5.js";
import { s as resolveMatrixAccountConfig } from "./config-paths-DjVNc5so.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-UWVi1FvN.js";
import "./runtime-api-C3kkMm-G.js";
import { l as shouldSuppressLocalMatrixExecApprovalPrompt, m as normalizeMatrixUserId, p as normalizeMatrixAllowList } from "./exec-approvals-DjNdVhKG.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-BunQ_tg3.js";
...
import { t as formatMatrixErrorMessage } from "./errors-CmvQtDzh.js";
import { n as legacyConfigRules, r as normalizeCompatibilityConfig, t as matrixOnboardingAdapter } from "./setup-surface-D3LKKo0p.js";
import { i as autoPrepareLegacyMatrixCrypto, o as autoMigrateLegacyMatrixState, r as resolveMatrixMigrationStatus } from "./matrix-migration.runtime-CG5Wt6nn.js";
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-1afRpZy2.js";
import { f as setMatrixThreadBindingMaxAgeBySessionKey, u as setMatrixThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings-shared-z2EeOozJ.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CFnxspv2.js";
import { a as singleAccountKeysToMove, i as resolveSingleAccountPromotionTarget, r as namedAccountPromotionKeys, t as matrixSetupAdapter } from "./setup-core-DJqVQ0rn.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-Brb_CflQ.js");
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./resolver.runtime-C4apBb2b.js"), "matrixResolverRuntime");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-MOCOHtyN.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-CaFoGGxK.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
