...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-_11V2h5W.js";
import { n as resolveCliName } from "./cli-name-Bp0WKT4X.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-CsFY4JD-.js";
import { h as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-BW4xc3GM.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-CH-N7oyG.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-B7wX-Bmr.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-BQO1NZLq.js";
...
import { t as runTui } from "./tui-GcMAH6g-.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DUC-w41q.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-BID-Jia1.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BQu5HwzV.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BQu5HwzV.js");
