...
import { l as resolveValidatedMatrixHomeserverUrl } from "./config-DzrMqyOz.js";
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-QjksSeZA.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-BhhN_JmS.js"), import("./logging-B-H1goKd.js")]).then(([sdkModule, loggingModule]) => ({
