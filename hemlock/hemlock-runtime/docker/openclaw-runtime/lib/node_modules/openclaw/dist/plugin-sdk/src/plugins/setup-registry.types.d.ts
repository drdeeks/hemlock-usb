...
export type SetupPluginAutoEnableProbe = (ctx: SetupPluginAutoEnableContext) => string | string[] | null | undefined;
...
export type SetupOnlyPluginModule = SetupOnlyPluginDefinition | ((api: SetupOnlyPluginApi) => void | Promise<void>);
