...
import { a as isRecord, c as readString, d as parseFeishuCommentTarget, n as encodeQuery, r as extractReplyText } from "./comment-shared-CggZDJtf.js";
import { a as createFeishuClient, f as resolveFeishuAccount, l as listEnabledFeishuAccounts, p as resolveFeishuRuntimeAccount, u as listFeishuAccountIds } from "./probe-D7PrZahm.js";
...
function formatCommentReactionFailure(error) {
	...
	return JSON.stringify({
		...
		feishu_log_id: readString(responseData?.log_id) || readString(isRecord(responseData?.error) ? responseData.error.log_id : void 0)
	});
}
...
//#endregion
export { jsonToolResult as a, createFeishuToolClient as c, resolveToolsConfig as d, looksLikeFeishuId as f, createCommentTypingReactionLifecycle as i, resolveAnyEnabledFeishuToolsConfig as l, resolveReceiveIdType as m, registerFeishuDriveTools as n, toolExecutionErrorResult as o, normalizeFeishuTarget as p, cleanupAmbientCommentTypingReaction as r, unknownToolActionResult as s, deliverCommentThreadText as t, resolveFeishuToolAccount as u };
