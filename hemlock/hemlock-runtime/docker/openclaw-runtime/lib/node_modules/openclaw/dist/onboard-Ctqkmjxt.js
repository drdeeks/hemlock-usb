...
import { s as isValidEnvSecretRefId } from "./types.secrets-B4TpMTxm.js";
...
import "./daemon-runtime-vfSjNJ6A.js";
import { t as resolveControlUiLinks } from "./control-ui-links-B-V8dnYt.js";
import { c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BW4xc3GM.js";
...
import { c as resolveManifestProviderOnboardAuthFlags, i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-YE-3W9pp.js";
import { t as runSetupWizard } from "./setup-DG478iTi.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-ZuUBaPIP.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-uwZEMLf0.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-kSy6sINl.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CPMRSEJ9.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C64rpYTg.js");
