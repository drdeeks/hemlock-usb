...
import { a as openVerifiedFileSync, f as isPathInside, i as openBoundaryFileSync } from "./boundary-file-read-C2FDLxpR.js";
import { m as resolveUserPath, p as resolveHomeDir, t as CONFIG_DIR } from "./utils-D5DtWkEu.js";
import { _ as mergeBundlePathLists, f as CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH, v as normalizeBundlePathList } from "./ids-ZUx9SnUD.js";
...
import { c as resolveEffectivePluginActivationState, l as resolveMemorySlotDecision, n as loadPluginManifestRegistry, s as normalizePluginsConfigWithResolver } from "./manifest-registry-DRnxzk1J.js";
import { r as hasKind } from "./slots-V5i3G255.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-padMFxe2.js";
import { r as normalizeSkillFilter, t as resolveEffectiveAgentSkillFilter } from "./agent-filter-CEM-NSLp.js";
import { a as normalizePluginsConfig, s as resolveEffectivePluginActivationState$1 } from "./config-state-DmPson1J.js";
import { i as resolveSandboxPath } from "./sandbox-paths-BsPbrjGT.js";
import { u as parseFrontmatterBlock } from "./frontmatter-5hfERsri.js";
import { d as resolveOpenClawMetadata, f as resolveSkillInvocationPolicy, l as shouldIncludeSkill, u as parseFrontmatter } from "./env-overrides-DqXzHel5.js";
...
function compactSkillPaths(skills) {
	const homes = [resolveHomeDir(), resolveUserHomeDir()].filter((home) => !!home).map((home) => path.resolve(home)).filter((home, index, all) => all.indexOf(home) === index).sort((a, b) => b.length - a.length);
