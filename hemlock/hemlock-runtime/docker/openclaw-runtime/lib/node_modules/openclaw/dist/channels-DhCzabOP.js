...
import { a as loadAuthProfileStore } from "./store-C5g_fGOG.js";
import "./auth-profiles-CEJUfPLd.js";
import { a as loadConfig, l as readConfigFileSnapshot } from "./io-B-YPX79V.js";
import { u as isChannelVisibleInConfiguredLists } from "./registry-DR0Inr-7.js";
...
import { t as danger } from "./globals-DQvpEApL.js";
...
import { o as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-0k29xLnx.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DXnLNrED.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-DCGD0-5j.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-B_T9A0B8.js";
import { n as formatTimeAgo } from "./format-relative-wfVso1Md.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-D1798JLA.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-iwBqBWyY.js";
import { t as createClackPrompter } from "./clack-prompter-DJmAaFaW.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-CkHFsCOK.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Mieg8Clw.js";
import { t as parseLogLine } from "./parse-log-line-CeLsmQxW.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-VX_OYCMz.js";
import { n as createChannelOnboardingPostWriteHookCollector, o as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks } from "./onboard-channels-7htvdY_W.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-wg2sKXLj.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-CKRUQnv_.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-DWvEeV2P.js"), import("./onboard-channels-BuzqDx4T.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-CS4YMsFI.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-CS4YMsFI.js");
			const prompter = createClackPrompter();
