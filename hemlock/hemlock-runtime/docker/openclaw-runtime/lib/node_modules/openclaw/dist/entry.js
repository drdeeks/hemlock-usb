...
import { N as isRootHelpInvocation, P as isRootVersionInvocation } from "./logger-CnaMaZPi.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-pzAQJGM1.js";
import { a as parseCliContainerArgs, n as applyCliProfileEnv, o as resolveCliContainerTarget, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-BQJeivqd.js";
...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-BaTNpvG0.js");
	...
	function tryHandleRootVersionFastPath(argv) {
		...
		Promise.all([import("./version-BcCXmt_B.js"), import("./git-commit-Dgg_CIfB.js")]).then(([{ VERSION }, { resolveCommitHash }]) => {
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-metadata-CrFKwlzk.js").then(async ({ outputPrecomputedRootHelpText }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-3Kd3X1tI.js").then(({ runCli }) => runCli(argv)).catch((error) => {
