...
import { a as warnMissingProviderGroupPolicyFallbackOnce, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-BUWwjQZ_.js";
...
import { i as resolveDirectDmAuthorizationOutcome, o as resolveSenderCommandAuthorizationWithRuntime } from "./command-auth-BNI2Gxd-.js";
import { n as isZaloSenderAllowed, t as evaluateZaloGroupAccess } from "./group-access-D-4V8J2I.js";
import { t as getZaloRuntime } from "./runtime-api-Db9nDqcn.js";
import { a as getUpdates, c as sendMessage, l as sendPhoto, n as ZaloApiError, o as getWebhookInfo, r as deleteWebhook, s as sendChatAction, t as resolveZaloProxyFetch, u as setWebhook } from "./proxy-ZJ1Spr5l.js";
...
async function handleZaloWebhookRequest(req, res) {
	const { handleZaloWebhookRequest: handleZaloWebhookRequestInternal } = await import("./monitor.webhook-BfdCNlQ4.js");
...
async function monitorZaloProvider(options) {
	...
	try {
		if (useWebhook) {
			const { registerZaloWebhookTarget } = await import("./monitor.webhook-BfdCNlQ4.js");
