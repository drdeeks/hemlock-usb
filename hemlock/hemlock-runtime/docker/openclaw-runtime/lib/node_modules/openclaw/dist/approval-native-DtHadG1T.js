...
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-Cam6K90N.js";
...
import { a as isDiscordExecApprovalClientEnabled, i as isDiscordExecApprovalApprover, n as shouldHandleDiscordApprovalRequest, r as getDiscordExecApprovalApprovers } from "./ui-K32kSHRZ.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-BETsfjQD.js")).discordApprovalNativeRuntime
		})
	});
}
