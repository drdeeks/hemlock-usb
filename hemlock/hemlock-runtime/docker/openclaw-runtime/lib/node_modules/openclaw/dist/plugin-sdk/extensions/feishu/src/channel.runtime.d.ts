...
export declare const feishuChannelRuntime: {
    ...
    feishuOutbound: {
        ...
        shouldSuppressLocalPayloadPrompt?: (params: {
            ...
            accountId?: string | null;
            payload: import("openclaw/plugin-sdk").ReplyPayload;
            hint?: import("openclaw/plugin-sdk/channel-runtime").ChannelOutboundPayloadHint;
        }) => boolean;
        beforeDeliverPayload?: (params: {
            cfg: import("openclaw/plugin-sdk").OpenClawConfig;
            target: import("openclaw/plugin-sdk/channel-runtime").ChannelOutboundTargetRef;
            payload: import("openclaw/plugin-sdk").ReplyPayload;
            hint?: import("openclaw/plugin-sdk/channel-runtime").ChannelOutboundPayloadHint;
        }) => Promise<void> | void;
        ...
        sendPayload?: (ctx: import("openclaw/plugin-sdk/channel-runtime").ChannelOutboundPayloadContext) => Promise<import("openclaw/plugin-sdk/twitch").OutboundDeliveryResult>;
        sendFormattedText?: (ctx: import("openclaw/plugin-sdk/channel-runtime").ChannelOutboundFormattedContext) => Promise<import("openclaw/plugin-sdk/twitch").OutboundDeliveryResult[]>;
        sendFormattedMedia?: (ctx: import("openclaw/plugin-sdk/channel-runtime").ChannelOutboundFormattedContext & {
            mediaUrl: string;
