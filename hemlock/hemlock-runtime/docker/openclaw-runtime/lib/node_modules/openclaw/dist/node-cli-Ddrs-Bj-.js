...
import { o as sameFileIdentity } from "./boundary-file-read-C2FDLxpR.js";
...
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-ClewJyj-.js";
import { A as POSIX_INLINE_COMMAND_FLAGS, F as unwrapKnownDispatchWrapperInvocation, I as normalizeExecutableToken, M as resolveInlineCommandMatch, O as resolveShellWrapperTransportArgv, S as POSIX_SHELL_WRAPPERS, d as resolveApprovalAuditCandidatePath, k as unwrapKnownShellMultiplexerInvocation, p as resolveCommandResolutionFromArgv, y as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-D5XXp4K4.js";
import { a as logWarn } from "./logger-BYB3iw-K.js";
import { i as resolveAgentConfig } from "./agent-scope-C7LiYj5W.js";
import "./config-M6t0-B38.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-BISfElRb.js";
import { r as getActivePluginRegistry } from "./runtime-B5JkXHFO.js";
import { t as formatCliCommand } from "./command-format-CwCsVPsh.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-ijKGP-nu.js";
import { i as resolveDaemonNodeBinDir, n as emitDaemonInstallRuntimeWarning, o as resolveNodeProgramArguments, r as resolveDaemonInstallRuntimeInputs } from "./auth-token-resolution-DZOLBk0-.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-Cca7p8MV.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-vfSjNJ6A.js";
import { t as GatewayClient } from "./client-mAkhLNco.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-CY2OKQsD.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES } from "./message-channel-BHZEWLw5.js";
import { d as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, m as buildDaemonServiceSnapshot, n as createDaemonInstallActionContext, p as parsePort, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-CiHnhgte.js";
import { a as formatRuntimeStatus, i as buildPlatformServiceStartHints, r as buildPlatformRuntimeLogHints } from "./systemd-hints-V8vdjqcC.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-Dm_fU8-r.js";
import { t as getMachineDisplayName } from "./machine-name-CfOcLd4e.js";
import { t as splitShellArgs } from "./shell-argv-BOWyQlQO.js";
...
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-D-VNZ7sV.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-BfZJCi6V.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DbluZ_iR.js";
import { t as formatHelpExamples } from "./help-format-7aB74-Nx.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CR3m87sH.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-0n7joZ93.js";
import { t as resolveNodeService } from "./node-service-CyxkkMnl.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-DhoneAeJ.js");
