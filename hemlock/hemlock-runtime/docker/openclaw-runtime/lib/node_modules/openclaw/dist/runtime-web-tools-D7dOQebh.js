...
import { a as collectPluginConfigContractMatches, o as resolvePluginConfigContractsById } from "./setup-registry-bXawWa5K.js";
import { a as resolveManifestContractPluginIdsByCompatibilityRuntimePath, i as resolveManifestContractPluginIds } from "./manifest-registry-DRnxzk1J.js";
import { d as resolveSecretInputRef } from "./types.secrets-B4TpMTxm.js";
import { u as secretRefKey } from "./ref-contract-CG9Ki9BF.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-nPyF75ul.js";
import { h as resolveDefaultAgentId, m as resolveAgentWorkspaceDir } from "./agent-scope-C7LiYj5W.js";
import { a as normalizePluginsConfig, c as resolveEnableState } from "./config-state-DmPson1J.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-BVt1Od9X.js";
import "./shared-Cf8ndghq.js";
import { o as resolveSecretRefValues } from "./resolve-DiXsmEpb.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-BQpH8jex.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-CyT51CPi.js";
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-bXrpGuZ5.js";
import { n as resolveEffectiveMediaEntryCapabilities, r as buildMediaUnderstandingRegistry, t as resolveConfiguredMediaEntryCapabilities } from "./entry-capabilities-BOg5J81N.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-EJtY72-A.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-CU24Czk1.js";
import { r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-7DuQ64G_.js";
import { r as sortWebFetchProvidersForAutoDetect } from "./web-fetch-providers.shared-BFKM-M97.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-D9-6Utqm.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-C0JIzYsT.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-Cc_IAk6q.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-COSjqg0_.js"), (mod) => mod);
