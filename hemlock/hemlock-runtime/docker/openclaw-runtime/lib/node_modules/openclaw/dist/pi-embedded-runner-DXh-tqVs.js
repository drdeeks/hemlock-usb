...
import { t as isTruthyEnvValue } from "./env-jndHmrmK.js";
import { n as ensureAuthProfileStore } from "./store-C5g_fGOG.js";
import "./auth-profiles-CEJUfPLd.js";
import { r as normalizeProviderId } from "./provider-id-Dts8rixb.js";
import { H as normalizeGoogleApiBaseUrl, at as resolveOwnerDisplaySetting } from "./io-B-YPX79V.js";
import { _ as resolveStateDir } from "./paths-HZHKO_Jn.js";
import { b as isSubagentSessionKey, c as normalizeAgentId, l as normalizeMainKey, m as toAgentRequestSessionKey, u as resolveAgentIdFromSessionKey, y as isCronSessionKey } from "./session-key-L2XsSJT_.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-BckzHLk4.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DhRYxXov.js";
import "./workspace-_11V2h5W.js";
import { b as resolveSessionAgentIds, n as listAgentEntries, r as listAgentIds, s as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks } from "./agent-scope-C7LiYj5W.js";
import { f as resolveProfilesUnavailableReason, l as markAuthProfileFailure, n as resolveAuthProfileOrder, p as sanitizeForConsole, s as isProfileInCooldown, t as resolveAuthProfileEligibility, u as markAuthProfileUsed } from "./order-C0bmoNU_.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-BPEiUrBJ.js";
import { R as resolveProviderSystemPromptContribution, S as prepareProviderRuntimeAuth, Y as transformProviderSystemPrompt, tt as wrapStreamFnTextTransforms, z as resolveProviderTextTransforms } from "./provider-runtime-B5nLJVpC.js";
import { y as listRegisteredAgentHarnesses } from "./loader-b5gxFmeZ.js";
import { s as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-BfihYtV2.js";
import { r as resolveContextEngine } from "./registry-D_VU77c5.js";
import { r as markAuthProfileGood } from "./profiles-DT2g1T-s.js";
import { c as normalizeThinkLevel, u as normalizeVerboseLevel } from "./thinking.shared-BZ7s87RR.js";
import { _ as resolvePersistedSelectedModelRef, c as normalizeStoredOverrideModel, f as resolveDefaultModelForAgent } from "./model-selection-DP92S76A.js";
import { t as redactIdentifier } from "./redact-identifier-DQrgaT0p.js";
import { u as resolveStorePath } from "./paths-CrHqfnMp.js";
import { d as normalizeMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-BHZEWLw5.js";
import { t as ensureOpenClawModelsJson } from "./models-config-WTeIlzbI.js";
import { a as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DcS8sOxS.js";
import { t as ensureContextEnginesInitialized } from "./init-FTgPFe2X.js";
import { c as updateSessionStore } from "./store-Cw5RrVCw.js";
import { r as resolveExplicitAgentSessionKey } from "./main-session-D3efLc-S.js";
import "./sessions-BWz-crFz.js";
import { i as resolveChannelResetConfig, n as evaluateSessionFreshness, o as resolveSessionResetPolicy, s as resolveSessionResetType } from "./reset-CSt9R-yj.js";
import { n as resolveSessionKey } from "./session-key-CLSm5qo5.js";
import { i as resolveSessionLockMaxHoldFromTimeout, t as acquireSessionWriteLock } from "./session-write-lock-rU6v-RfX.js";
import { t as loadSessionStore } from "./store-load-DsLWM8wp.js";
import { n as sleepWithAbort } from "./backoff-Co9E7aKq.js";
import { c as hasNonzeroUsage, l as makeZeroUsageSnapshot, o as derivePromptTokens, u as normalizeUsage } from "./chat-envelope-DGarBiZe.js";
import { s as resolveAssistantMessagePhase } from "./chat-message-content-Dx0WxJrY.js";
import { t as parseInlineDirectives } from "./directive-tags-BqJjXrwT.js";
import { A as estimateMessagesTokens, B as truncateOversizedToolResultsInSessionManager, C as validateReplayTurns, D as buildEmbeddedExtensionFactories, E as limitHistoryTurns, F as resolveTranscriptPolicy, G as createBundleLspToolRuntime, H as repairSessionFileIfNeeded, I as guardSessionManager, J as resolveChannelCapabilities, K as releaseWsSession, L as estimateToolResultReductionPotential, M as resolveCompactionTimeoutMs, N as isCacheTtlEligibleProvider, O as dropThinkingBlocks, P as readLastCacheTtlTimestamp, R as sessionLikelyHasOversizedToolResults, S as sanitizeSessionHistory, T as getDmHistoryLimitFromSessionKey, U as toClientToolDefinitions, V as installToolResultContextGuard, W as createPreparedEmbeddedPiSettingsManager, X as captureCompactionCheckpointSnapshot, Y as filterHeartbeatPairs, Z as cleanupCompactionCheckpointSnapshot, _ as resolveEmbeddedAgentBaseStreamFn, a as runPostCompactionSideEffects, b as prewarmSessionFile, c as flushPendingToolResultsAfterIdle, d as collectAllowedToolNames, et as persistSessionCompactionCheckpoint, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, i as asCompactionHookRunner, k as SAFETY_MARGIN, l as mapThinkingLevel, m as createSystemPromptOverride, o as buildEmbeddedCompactionRuntimeContext, p as buildEmbeddedSystemPrompt, q as buildStreamErrorAssistantMessage, r as readPiModelContextTokens, s as resolveEmbeddedCompactionTarget, tt as resolveSessionCompactionCheckpointReason, u as splitSdkTools, v as resolveEmbeddedAgentStreamFn, w as buildEmbeddedMessageActionDiscoveryInput, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as truncateOversizedToolResultsInSession } from "./compact-g-BGaE4t.js";
import { i as enqueueCommandInLane } from "./command-queue-JOCs7lw4.js";
import { i as resolveContextWindowInfo, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-BaVMyzQD.js";
import { a as extractToolResultText, c as isToolResultTimedOut, d as isMessagingToolSendAction, f as normalizeEmbeddedAgentRuntime, i as extractToolResultMediaArtifact, l as sanitizeToolResult, m as resolveEmbeddedAgentRuntime, n as extractMessagingToolSend, o as filterToolResultMediaUrls, p as resolveEmbeddedAgentHarnessFallback, r as extractToolErrorMessage, s as isToolResultError, t as buildEmbeddedAttemptToolRunContext, u as isMessagingTool } from "./attempt.tool-run-context-98fz_X4e.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-CIoRklU5.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-DZ3SiiVS.js";
import { t as getMachineDisplayName } from "./machine-name-CfOcLd4e.js";
import { n as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciStreamTimeouts } from "./undici-global-dispatcher-D8nttVY6.js";
import { f as MAX_IMAGE_BYTES } from "./mime-Ci7oOV2D.js";
import { n as buildTtsSystemPromptHint } from "./tts-g32FpVk_.js";
import { t as isReasoningTagProvider } from "./provider-utils-D0ytrVUY.js";
import { t as parseBooleanValue } from "./boolean-s1IOcHAK.js";
import { n as estimateBase64DecodedBytes } from "./base64-fcs4g96r.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-D6czjo8S.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-DVJy--5v.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, o as resolveHeartbeatPromptForSystemPrompt, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-Z7VSltzH.js";
import { A as parseImageSizeError, D as isRateLimitAssistantError, E as isLikelyContextOverflowError, F as resolveBootstrapTotalMaxChars, N as resolveBootstrapMaxChars, P as resolveBootstrapPromptTruncationWarningMode, S as isCompactionFailureError, T as isFailoverErrorMessage, _ as extractObservedOverflowTokenCount, a as isMessagingToolDuplicateNormalized, b as isBillingAssistantError, d as downgradeOpenAIFunctionCallReasoningPairs, k as parseImageDimensionError, m as classifyFailoverReason, n as validateGeminiTurns, o as normalizeTextForComparison, r as pickFallbackThinkingLevel, t as validateAnthropicTurns, u as sanitizeToolCallIdsForCloudCodeAssist, v as formatAssistantErrorText, w as isFailoverAssistantError, x as isCloudCodeAssistFormatError, y as isAuthAssistantError } from "./pi-embedded-helpers-BD0z98Ym.js";
import { n as formatRawAssistantErrorForUi } from "./assistant-error-format-DaK39TzJ.js";
import { C as isTimeoutErrorMessage, D as parseExecApprovalResultText, d as stableStringify$1, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-D2LemHTA.js";
import { l as normalizeToolName } from "./tool-policy-DzEKj41v.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BuMB4mti.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-DFYmurz4.js";
import { c as listChannelSupportedActions, d as resolveChannelReactionGuidance, l as resolveChannelMessageToolCapabilities, u as resolveChannelMessageToolHints } from "./tools-CtIcMWPU.js";
import { t as resolveOpenClawDocsPath } from "./docs-path-Cw9CLejY.js";
import { a as isTimeoutError, n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-BjoqUC62.js";
import { t as buildModelAliasLines } from "./model-alias-lines-HDkUH1mU.js";
import { c as resolveModelAuthMode, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-BcUEPfGz.js";
import { a as logProviderToolSchemaDiagnostics, i as shouldUseOpenAIWebSocketTransport, n as composeSystemPromptWithHookContext, o as normalizeProviderToolSchemas, r as resolveAttemptSpawnWorkspaceDir, s as supportsModelTools, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-pPeqJHno.js";
import { l as sanitizeTransportPayloadText, n as registerProviderStreamForModel, s as mergeTransportHeaders, u as buildGuardedModelFetch } from "./anthropic-vertex-stream-Doy9whjL.js";
import { c as resolveProviderRequestConfig, f as sanitizeRuntimeProviderRequestOverrides } from "./provider-request-config-CJHK-93o.js";
import { t as log$3 } from "./logger-4EfpsAw2.js";
import { r as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-BHMu-0fx.js";
import { i as stripSystemPromptCacheBoundary, n as prependSystemPromptAdditionAfterCacheBoundary } from "./system-prompt-cache-boundary-B6zvhybg.js";
import { t as parseGeminiAuth } from "./gemini-auth-sGhif_Bp.js";
import { i as getOrCreateSessionMcpRuntime, n as materializeBundleMcpToolsForRun, r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-acACZGZo.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-KzNDpsbG.js";
import { r as parseFenceSpans } from "./fences-D_LPHxRE.js";
import { v as parseReplyDirectives, y as splitMediaFromOutput } from "./deliver-CjBTircm.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-C-MyOxXD.js";
import { r as resolveToolDisplay } from "./tool-display-Bzy0IwK_.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent, s as emitAgentPlanEvent } from "./agent-events-BrSNDEDb.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CipoAzdh.js";
import { D as buildApiErrorObservationFields, O as buildTextObservationFields, _ as isStrictAgenticExecutionContractActive, a as buildActiveVideoGenerationTaskPromptContextForSession, l as LiveSessionModelSwitchError, o as buildActiveMusicGenerationTaskPromptContextForSession, u as shouldAllowCooldownProbeForReason } from "./openclaw-tools-C-4xhzGY.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-eWLbmzpC.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-BkBC0s0M.js";
...
import { o as buildExecApprovalPendingReplyPayload, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-BhpFcpTV.js";
import { t as consumeAdjustedParamsForToolCall } from "./pi-tools.before-tool-call-CXO7TUbf.js";
import { n as applyPiAutoCompactionGuard } from "./pi-settings-DSR7qq_Y.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-D36Y1JfN.js";
import { i as generateSecureToken } from "./secure-random-CsODx7RS.js";
import { n as detectRuntimeShell } from "./supervisor-Cvk622m_.js";
import { c as resolveEffectiveToolFsWorkspaceOnly } from "./local-roots-ARVv8hDR.js";
import { o as resolveGlobalLane, s as resolveSessionLane } from "./queue-AttL4x6M.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-CU8RMdxt.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Be5OnPsr.js";
import { c as resolveSkillsPromptForRun } from "./skills-B5qdBn1G.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DqXzHel5.js";
import { o as resolveSandboxContext } from "./sandbox-DwAoNjTH.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-CM8F_irR.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-BsMojl-5.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-D3UYv6Rv.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-DdUUze7Y.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-Dx8aBFIu.js";
import { a as resolveCacheRetention, i as isGooglePromptCacheEligible, n as resolveAgentTransportOverride, t as applyExtraParamsToAgent } from "./extra-params-OIS_uVi7.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-DtGfqu5w.js";
import { n as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-CVh9iSDb.js";
import { n as resolveRunWorkspaceDir, r as detectAndLoadPromptImages, t as redactRunIdentifier } from "./workspace-run-CoszYENZ.js";
import "./ollama-runtime-CoZTJg0P.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-CMT22uiW.js";
import { n as resolveModelAsync } from "./model-CPrqtDbi.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-HcqnpKjB.js");
...
function collectEmittedToolOutputMediaUrls(toolName, outputText, result) {
...
async function emitToolResultOutput(params) {
	...
	if (ctx.shouldEmitToolOutput() || shouldEmitCompactToolOutput({
		...
		if (outputText) {
			if (ctx.params.toolResultFormat === "plain") emittedToolOutputMediaUrls = collectEmittedToolOutputMediaUrls(toolName, outputText, result);
...
function sanitizeAnthropicReplayToolResults(messages) {
	...
	for (let index = 0; index < messages.length; index += 1) {
		...
		const nextContent = message.content.filter((block) => {
			...
			const typedBlock = block;
			if (typedBlock.type !== "toolResult" || typeof typedBlock.toolUseId !== "string") return true;
...
function wrapStreamFnSanitizeMalformedToolCalls(baseFn, allowedToolNames, transcriptPolicy) {
	return (model, context, options) => {
		...
		if (sanitized.messages === messages) return baseFn(model, context, options);
		let nextMessages = sanitizeToolUseResultPairing(sanitized.messages);
		if (transcriptPolicy?.validateAnthropicTurns) nextMessages = sanitizeAnthropicReplayToolResults(nextMessages);
		...
		try {
			...
			if (transcriptPolicy.sanitizeToolCallIds && transcriptPolicy.toolCallIdMode) {
				...
				activeSession.agent.streamFn = (model, context, options) => {
					const messages = context?.messages;
					if (!Array.isArray(messages)) return inner(model, context, options);
					const sanitized = sanitizeToolCallIdsForCloudCodeAssist(messages, mode, { preserveNativeAnthropicToolUseIds: transcriptPolicy.preserveNativeAnthropicToolUseIds });
					if (sanitized === messages) return inner(model, context, options);
					return inner(model, {
						...context,
						messages: sanitized
			...
			if (params.model.api === "openai-responses" || params.model.api === "azure-openai-responses" || params.model.api === "openai-codex-responses") {
				const inner = activeSession.agent.streamFn;
				activeSession.agent.streamFn = (model, context, options) => {
					const messages = context?.messages;
					if (!Array.isArray(messages)) return inner(model, context, options);
			...
			try {
				...
				if (leafEntry?.type === "message" && leafEntry.message.role === "user") {
					...
					const orphanRepairMessage = `Removed orphaned user message to prevent consecutive user turns. runId=${params.runId} sessionId=${params.sessionId} trigger=${params.trigger}`;
				...
				if (shouldRecordCompletedBootstrapTurn && !promptError && !aborted && !yieldAborted && !timedOutDuringCompaction && !compactionOccurredThisAttempt) try {
		...
		return enqueueGlobal(async () => {
			...
			try {
				...
				while (true) {
					...
					const { aborted, promptError, promptErrorSource, preflightRecovery, timedOut, idleTimedOut, timedOutDuringCompaction, sessionIdUsed, lastAssistant: sessionLastAssistant, currentAttemptAssistant } = attempt;
