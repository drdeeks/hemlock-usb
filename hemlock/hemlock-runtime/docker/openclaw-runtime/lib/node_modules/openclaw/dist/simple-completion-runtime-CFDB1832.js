...
import { a as resolveAgentDir, o as resolveAgentEffectiveModelPrimary } from "./agent-scope-C7LiYj5W.js";
import { O as splitTrailingAuthProfile, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-DP92S76A.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-BcUEPfGz.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-B_GlK606.js");
